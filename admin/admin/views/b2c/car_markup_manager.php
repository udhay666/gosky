            ...
            <div class="x_panel">
               <div class="x_title">
                  <ul class="nav nav-tabs navbar-left nav-dark">
                     <li class="active"><a href="#home2" data-toggle="tab"><strong>Generic (XML Based) Car Markup </strong></a></li>
                     <li ><a href="#profile2" data-toggle="tab"><strong>SPECIFIC (Country Based) Car Markup Master</strong></a></li>
               ...
               <div class="x_content">
                  ...
                  <div class="tab-content mb30">
                     <div class="tab-pane active" id="home2">
                        ...
                        <div class="table-responsive">
                           <table  class="table table-striped table-bordered">
                              <form class="form-horizontal" name='hotel_genericb2c' id="hotel_genericb2c" method="post" action="<?php echo site_url()?>/b2c/update_b2c_markups">
                        ...
                        <div class="table-responsive">
                           ...
                           <table id="datatable2" class="table table-striped table-bordered">
                              ...
                              <tbody>
                                 ...
                                 <?php if($b2c_markup_list[$i]->service_type == 4 && $b2c_markup_list[$i]->markup_type== 'generic') {?>
                                 <tr>
                                    <td><?php echo $j+1;?></td>
                                    ...
                                    <td class="center">
                                      <!--  <a class="manageB2CHotelMarkupStatus" href="javascript:void(0);" title="Active" data-rel="tooltip" data-base-url="<?php echo site_url();?>/" data-value="1" data-markup-id="<?php echo $b2c_markup_list[$i]->markup_id;?>" >
                                       ...
                                       <i class="fa fa-trash-o"></i>
                                        ...
                                        <a href="<?php echo site_url(); ?>/b2c/b2c_car_markup_status/<?php echo $b2c_markup_list[$i]->markup_id;  ?>/1" onclick="return confirm('Do you really want to Active this Markup. ?')">
                                       <span class="glyphicon glyphicon-ok-sign"></span>
                                       </a>
                                       <a href="<?php echo site_url(); ?>/b2c/b2c_car_markup_status/<?php echo $b2c_markup_list[$i]->markup_id;  ?>/0" onclick="return confirm('Do you really want to InActive this Markup. ?')">
                                       <span class="glyphicon glyphicon-minus-sign"></span>
                                       </a>
                                        <a href="<?php echo site_url(); ?>/b2c/b2c_car_markup_status/<?php echo $b2c_markup_list[$i]->markup_id;  ?>/2" onclick="return confirm('Do you really want to Delete this Markup. ?')">
                                       <i class="fa fa-trash-o"></i>
                                       </a>
                                    </td>
                                 </tr>
                     ...
                     <div class="tab-pane" id="profile2">
                        ...
                        <div class="table-responsive">
                           <table  class="table table-striped table-bordered">
                              <form class="form-horizontal" name="hotel_specificb2c" id="hotel_specificb2c" action="<?php echo site_url()?>/b2c/update_b2c_markups" method="post">
                                 <input type="hidden" name="service_type" value="4">
                        ...
                        <div class="table-responsive">
                           ...
                           <table id="datatable4" class="table table-striped table-bordered">
                              ...
                              <tbody>
                                 ...
                                 <?php $j=0;
                                    for($i=0;$i<count($b2c_markup_list);$i++) {?>
                                 <?php if($b2c_markup_list[$i]->service_type == 4 && $b2c_markup_list[$i]->markup_type== 'specific') {?>
                                 <tr>
                                    <td><?php echo $j+1;?></td>
                                    <td><?php echo $b2c_markup_list[$i]->api_name;?></td>
                                    <td class="center"><?php echo $b2c_markup_list[$i]->country;?></td>
                     ...
                     <div class="tab-pane" id="profile3">
                        ...
                        <div class="table-responsive">
                           <table id="datatable5" class="table table-striped table-bordered">
                              <form class="form-horizontal" name="car_specificb2c" id="car_specificb2c_name" action="" >
                                 <fieldset>
                                    <tr>
                                       <td class="">API</td>
                                       <td class="col-sm-3">
                                    ...
                                    <tr>
                                       ...
                                       <td class="center">Markup</td>
                                       <td>
                                          <input class="required" id="markup1" type="text" name="markup"  style="width:40px;" required> Percent | Fixed
                                       </td>
                                       <td>
                                          <button type="submit" class="btn btn-primary">Add MarkUp</button>
                                       </td>
                        ...
                        <div class="table-responsive">
                           ...
                           <table id="datatable6" class="table table-striped table-bordered">
                              ...
                              <tbody>
                                 ...
                                 <?php $j=0;
                                    for($i=0;$i<count($b2c_markup_list);$i++) {?>
                                 <?php if($b2c_markup_list[$i]->service_type == 4 && $b2c_markup_list[$i]->markup_type== 'specific_hotel') {?>
                                 <tr>
                                    <td><?php echo $j+1;?></td>
