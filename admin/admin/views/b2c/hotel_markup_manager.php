                           ...
                           <table id="datatable2" class="table table-striped table-bordered">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td class="center">
                                       <a class="manageB2CHotelMarkupStatus" href="javascript:void(0);" title="Active" data-rel="tooltip" data-base-url="<?php echo site_url();?>/" data-value="1" data-markup-id="<?php echo $b2c_markup_list[$i]->id;?>" >
                                       <span class="glyphicon glyphicon-ok-sign"></span>
                                       </a>
                                       <a class="manageB2CHotelMarkupStatus" href="javascript:void(0);" title="Inactive" data-rel="tooltip" data-base-url="<?php echo site_url();?>/" data-value="0" data-markup-id="<?php echo $b2c_markup_list[$i]->id;?>" >
                                       <span class="glyphicon glyphicon-minus-sign"></span>
                                       </a>
                                       <a class="manageB2CHotelMarkupStatus" href="javascript:void(0);" title="Delete" data-rel="tooltip" data-base-url="<?php echo site_url();?>/" data-value="2" data-markup-id="<?php echo $b2c_markup_list[$i]->id;?>" >
                              ...
                              <form class="form-horizontal" name="hotel_specificb2c" id="hotel_specificb2c_name" action="" >
                                 <fieldset>
                                    ...
                                    <tr>
                                       ...
                                       <td class="center">Markup</td>
                                       <td>
                                          <input class="required" id="markup1" type="text" name="markup1"  style="width:40px;" required> Percent | Fixed
                                       </td>
                                       <td>
                                          <button type="submit" class="btn btn-primary">Add MarkUp</button>
                                       </td>
