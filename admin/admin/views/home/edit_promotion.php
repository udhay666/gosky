     ...
     <div class="row">
       ...
       <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <!--HOLIDAYS &nbsp;<input class="input-xlarge focused" id="selectError1" type="checkbox" name="service_type[]" value="6" <?php echo (in_array(6,$pr_st)) ? 'checked="checked"': ''; ?>>-->
              ...
              <div class="form-group">
								...
								<div class="col-sm-6">
								  <input class="form-control" id="focusedInput" type="text" name="promo_code" value="<?php echo $promotion_list->promo_code; ?>" readonly> 
                              ...
                              <div class="form-group">
								...
								<div class="col-sm-6">
								  <select name="type_discount" required class="form-control">
										...
										<option value="2" <?php echo (($promotion_list->discount_type == 2) ? 'selected="selected"': ''); ?>>Fixed</option>
								  </select>
								</div>
							  </div>
                              <div class="form-group">
                              ...
                              <div class="col-sm-6 xdisplay_inputx form-group has-feedback">
								  ...
								  <input id="pr_expire" class="form-control has-feedback-left" type="text" value="<?php echo $promotion_list->promo_expire; ?>" name="promo_expire"  aria-describedby="inputSuccess2Status3" required >
