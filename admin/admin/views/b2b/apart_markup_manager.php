		...
		<div class="content">
           ...
           <div class="row-fluid">
				<div class="span12">
					<div class="box">
						<div class="box-head tabs">
							<h3>Apartment Markup Manager</h3>
                           
                                
                           <ul class="nav nav-pills">                           
								<li class="active">
									<a data-toggle="tab" href="#hotel-markup">Apartment Markup Manager</a>
								</li>								
							</ul>							
						</div>
						<div class="box-content box-nomargin">
							<div class="tab-content">
									<div class="tab-pane active" id="hotel-markup">
                                    	<legend>GENERIC (XML Based) Apartment Markup Master</legend> 
                        
                  						 <table width="100%" border="0" cellpadding="3" cellspacing="0">
					
                    <form class="form-horizontal" name='apart_generic' id="apart_generic" action="">
                  <fieldset>
                      <tr> 
              ...
              <select id="selectError3" name="hotel_gen_api" required>
                        <option value="all">ALL</option>
                        <optgroup label="Apartment API List">                                       
                        <?php
						  ...
						  for($i=0;$i<count($b2b_markup_list);$i++) {?>
							...
							<tr>
								...
								<td class="center">
                                    ...
                                    <a class="btn btn-small manageB2BApartmentMarkupStatus" href="javascript:void(0);" title="Active" data-rel="tooltip" data-base-url="<?php echo site_url(); ?>" data-value="1" data-markup-id="<?php echo $b2b_markup_list[$i]->markup_id;?>" >
										<i class="icon-ok"></i>			                                          
									</a>
                                     <a class="btn btn-small manageB2BApartmentMarkupStatus" href="javascript:void(0);" title="Inactive" data-rel="tooltip" data-base-url="<?php echo site_url(); ?>" data-value="0" data-markup-id="<?php echo $b2b_markup_list[$i]->markup_id;?>" >
										<i class="icon icon-color icon-remove"></i>			                                          
									</a>
									<a class="btn btn-danger manageB2BApartmentMarkupStatus" href="javascript:void(0);" title="Delete" data-rel="tooltip" data-base-url="<?php echo site_url(); ?>" data-value="2" data-markup-id="<?php echo $b2b_markup_list[$i]->markup_id;?>" >
...
<!--                                        <legend>SPECIFIC (Country Based) Apartment Markup Master</legend>-->
                                          
<!--                                          <table width="100%" border="0" cellpadding="3" cellspacing="0">
                                        
                                        <form class="form-horizontal" name="apart_specific" id="apart_specific" action="" >
                                      <fieldset>
                                          <tr>
                                          <td class="center">Agent</td>
                                            <td>                                        
...
$(document).ready(function() {
	...
	$("#apart_generic").submit(function(ev){
		ev.preventDefault();    
		...
		if(confirm('Are you sure you want to Add/Update B2B Generic Apartment MarkUp?')) {
			 ...
			 $.ajax({
				...
				window.location = '<?php echo site_url(); ?>/b2b/apart_markup_manager';
				}
	...
	$("#apart_specific").submit(function(ev){
		ev.preventDefault();    
		...
		if(confirm('Are you sure you want to Add/Update B2B Specific Apartment MarkUp?')) {
