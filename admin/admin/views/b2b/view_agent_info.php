			...
			<form class="form-horizontal" action="<?php echo site_url(); ?>/b2b/update_agent_info" enctype="multipart/form-data" method="post">
				<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<label class="col-sm-3 control-label" for="focusedInput">Current Logo</label>
							<img class="grayscale" alt="Agent Logo" src="<? echo $agent_info->agent_logo; ?>" style="display: block;" height="100px" width="100px" align="middle">
							<div class="uploader" id="uniform-file2">
								<input  type="file" class="uniform" id="file2" name="agency_logo" size="19" style="opacitys: 0;" />
								<span class="filename" style="-moz-user-select: none;"></span>
								<span class="action" style="-moz-user-select: none;">Choose New Logo</span>
							</div>
						</div>
					</div>
						...
						<div class="col-sm-6">
							<select data-placeholder="Select Your Agent Type"  class="form-control" id="selectError2" data-rel="chosen" name="agent_type" required>
								...
								<optgroup label="agent List">
									...
									<option value="2" selected>Corporate User</option>
								</optgroup>
							</select>
						</div>
					</div>
