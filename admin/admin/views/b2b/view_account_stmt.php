                        ...
                        <div class="col-sm-6">
                           <label class="radio">
                              <div class="uniRadio" id="uniform-radio2">
                                 <span class="checked">
                                 <input type="radio" id="radio1" checked="" value="deposit" class="uniform" name="transaction_type">
                                 </span>
                              </div>
                              Deposit Amount
                           </label>
                           ...
                           <label class="radio">
                              <div class="uniRadio" id="uniform-radio2">
                                 <span class="checked">
                                 <input type="radio" id="radio2" value="withdraw" class="uniform" name="transaction_type" >
                                 </span>
                              </div>
                              Withdraw Amount
                           </label>
