...
<div class="col-md-8">
<table border="1px"><tr><th colspan="2" style="text-align:center">Bizzholidays Flight Voucher</th></tr>
...
<tr><th>Flight  Booking Reference No.</th><th><?php echo $booking_info[$i]->BookingRefId; ?></th></tr>
...
<tr><th>Airline</th><th><?php echo $booking_info[$i]->OperatingAirline_Code; ?></th></tr>
<tr><th>Flight Name</th><th><?php echo $booking_info[$i]->OperatingAirline_FlightNumber; ?></th></tr>
...
<tr><th>Origin</th><th><?php echo $booking_info[$i]->Origin; ?></th></tr>
<tr><th>Destination</th><th><?php echo $booking_info[$i]->Origin; ?></th></tr>
<tr><th>Booking Date</th><th><?php echo date('d-m-y',strtotime($booking_info[$i]->booking_date)); ?></th></tr>
...
<tr><th>SKPL Tax</th><th><?php echo $booking_info[$i]->Tax_Amount; ?></th></tr>
