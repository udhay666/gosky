...
<table style="text-align:left"><tr><th colspan="2" style="text-align:center">Bizzholidays Invoice <?php echo $booking_info[$i]->tbo_invoice_no  ?></th></tr>
...
<tr><th>Return Date</th><th><?php  $dep_time=explode('T',$flight_booking_summary[$i]->ArrivalDateTime);echo $dep_time1=date('d-m-y',strtotime($dep_time[0])) ?></th>	</tr>
</table>
<?php   } }?>
...
<tr><th>Taxes</th><th><?php echo $booking_info[$i]->Tax_Amount ; ?></th></tr>
