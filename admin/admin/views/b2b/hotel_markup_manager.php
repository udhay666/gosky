                     ...
                     <div class="tab-pane active" id="hotel-markup">
                        ...
                        <div class="table-responsive">
                           <table id="datatable5" class="table table-striped table-bordered">
                              <!--  <table width="100%" border="0" cellpadding="3" cellspacing="0"> -->
                              <form class="form-horizontal" name='hotel_generic' id="hotel_generic" action="<?php echo site_url()?>/b2b/update_b2b_markups" method="post">
                                 ...
                                 <fieldset>
                                    <tr>
                                       ...
                                       <td>
                                          <select id="selectError2" name="agent_no" required>
                              ...
                              <tbody>
                                 ...
                                 <?php
                                    if($b2b_markup_list[$i]->agent_no == 'all'){
                                     ...
                                     // echo '<pre/>';print_r($agency_nme1);//exit;
                                 ...
                                 <tr>
                                    ...
                                    <td class="center"><?php echo $b2b_markup_list[$i]->created_at;?></td>
                                    <td class="center">
                                    ...
                                    <td class="center">
                                       <a class=" manageB2BHotelMarkupStatus" href="javascript:void(0);" title="Active" data-rel="tooltip" data-base-url="<?php echo site_url(); ?>/" data-value="1" data-markup-id="<?php echo $b2b_markup_list[$i]->id;?>" >
                                       <span class="glyphicon glyphicon-ok-sign"></span>
                                       </a>
                                       <a class=" manageB2BHotelMarkupStatus" href="javascript:void(0);" title="Inactive" data-rel="tooltip" data-base-url="<?php echo site_url(); ?>/" data-value="0" data-markup-id="<?php echo $b2b_markup_list[$i]->id;?>" >
                                       <span class="glyphicon glyphicon-minus-sign"></span>
                                       </a>
                                       <a class=" manageB2BHotelMarkupStatus" href="javascript:void(0);" title="Delete" data-rel="tooltip" data-base-url="<?php echo site_url(); ?>/" data-value="2" data-markup-id="<?php echo $b2b_markup_list[$i]->id;?>" >
                               ...
                               <form class="form-horizontal" name="flight_specific" id="flight_specific" action="<?php echo site_url()?>/b2b/update_b2b_markups" method="post">
                                 ...
                                 <fieldset>
                                    <tr>
                                       <td class="center">Agent</td>
                                       <td>
                                          <select id="selectError1" name="agent_no" required>
                                             <option value="all">ALL</option>
                                             <optgroup label="Active Agent List">
                                                <?php
                                                   for($i=0;$i<count($agent_list);$i++) {?>
                             ...
                             <form class="form-horizontal" name="flight_specific" id="flight_specific" action="<?php echo site_url()?>/b2b/update_b2b_markups" method="post">
                                 ...
                                 <fieldset>
                                    ...
                                    <tr>
                                       ...
                                       <td class="center">Markup</td>
                                       <td>
                                          <input class="required" id="hotel_spec_markup1" type="text" name="markup"  style="width:40px;" required> Percent | Fixed
                                       </td>
                                       <td>
                                          <button type="submit" class="btn btn-primary">Add MarkUp</button>
                                       </td>
