                  ...
                  <div class="tab-content mb30">
                     <div class="tab-pane active" id="flight-markup">
                        ...
                        <div class="table-responsive">
                           <table  class="table">
                              <form class="form-horizontal" method="POST" name='flight_genericb2c' id="flight_genericb2c" action="<?php echo site_url()?>/b2b/update_b2b_markups">
                           ...
                           <table id="datatable2" class="table table-striped table-bordered">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td class="center">
                                       <a class=" manageB2BFlightMarkupStatus" href="javascript:void(0);" title="Active" data-rel="tooltip" data-base-url="<?php echo site_url();?>/" data-value="1" data-markup-id="<?php echo $b2b_markup_list[$i]->id;?>" >
                                       <span class="glyphicon glyphicon-ok-sign"></span>                                             
                                       </a>
                                       <a class=" manageB2BFlightMarkupStatus" href="javascript:void(0);" title="Inactive" data-rel="tooltip" data-base-url="<?php echo site_url();?>/" data-value="0" data-markup-id="<?php echo $b2b_markup_list[$i]->id;?>" >
                                       <span class="glyphicon glyphicon-minus-sign"></span>                                                  
                                       </a>
                                       <a class=" manageB2BFlightMarkupStatus" href="javascript:void(0);" title="Delete" data-rel="tooltip" data-base-url="<?php echo site_url();?>/" data-value="2" data-markup-id="<?php echo $b2b_markup_list[$i]->id;?>" >
                           ...
                           <table  class="table">
                              <form class="form-horizontal" name="flight_specific" id="flight_specific" action="<?php echo site_url()?>/b2b/update_b2b_markups" method="post">
                                 ...
                                 <tr>
                                    ...
                                    <td class="center">Country</td>
                                    <td>
                                    <select id="selectError6" name="country"  class="selectdata" required>
                                 ...
                                 <tr>
                                    ...
                                    <td class="center">Markup</td>
                                    <td>
                                       <input class="required" id="flight_spec_markup" type="text" name="markup"  style="width:40px;" required> Percent | Fixed
                                    </td>
                                    <td>
                                       <button type="submit" class="btn btn-primary">Add MarkUp</button>
                                    </td>
