  ...
  <div class="">
    ...
    <div class="row">
     <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
         <h2>&nbsp;<?php echo $holiday_list->package_title; if(!empty($holiday_list->package_code)){ echo ' ( Code : '.$holiday_list->package_code.' )'; }  ?>
        ...
        for($i=0;$i<=($holiday_list->duration);$i++) {
            ...
            // foreach ($hol_itinerary as $val) {
              ...
              <div class="form-group">
                <label class="col-sm-3  control-label"><input type="hidden" name="day_no[]" style="width:164px;" value="<?php echo ($i+1); ?>" placeholder="Day Wise"/>Itinerary Day <?php echo ($i+1); ?> : Header</label>
                <div class="col-sm-6 " style="width:70%">
                <input type="text" class="form-control" name="itineraryheader_<?php echo ($i+1); ?>" value="<?php echo $hol_itinerary[$i]->itineraryheader; ?>" required="required"/>               
                </div>                
              </div>
              <div class="form-group">
               <label class="col-sm-3  control-label">Itinerary Day <?php echo ($i+1); ?> : Description </label>
              <div class="col-sm-6 " style="width:70%">
                  <textarea class="form-control ckeditor" name="itinerary[]" placeholder="Itinerary" rows="3" cols="100" required="required"><?php echo $hol_itinerary[$i]->itinerary; ?></textarea>
                </div>
              </div>
              ...
              ?>
               <div class="form-group">
                <label class="col-sm-3  control-label"><input type="hidden" name="day_no[]" style="width:164px;" value="<?php echo ($i+1); ?>" placeholder="Day Wise"/>Itinerary Day <?php echo ($i+1); ?> : Header</label>
                <div class="col-sm-6 " style="width:70%">
                <input type="text" class="form-control" name="itineraryheader_<?php echo ($i+1); ?>" value="" required="required"/>               
                </div>                
              </div>
              <div class="form-group">
                <label class="col-sm-3  control-label">Itinerary Day <?php echo $i; ?> : Description</label>
                <div class="col-sm-6 " style="width:70%">
