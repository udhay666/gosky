      ...
      <div class="x_content">
        ...
        <form class="form-horizontal" action="<?php echo site_url('holiday/editholidaylist'); ?>"  method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                    ...
                    <div class="col-sm-6 ">
                        Yes
                        <input   name="bookable"   type="radio" class="required" value="1" required <?php if($edit->bookable==1){ echo "checked";} ?>/>
                        &nbsp;|&nbsp;No
                        <input   name="bookable"   type="radio" class="required" value="0" required <?php if($edit->bookable==0){ echo "checked";}?>/>
                    </div>
           </div>
          <div class="form-group warning">
              ...
              <div class="form-group warning">
                <label class="col-sm-3 control-label" class="col-sm-3 control-label" for="focusedInput">Package Code</label>
                <div class="col-sm-6">
                    <input class="form-control" name="package_code"   id="package_code" type="text" class="required" value="<?php echo $edit->package_code; ?>" style="width:275px;" required/>
                </div>
            </div>
              <div class="form-group">
                <?php $taggingservices=explode(',', $edit->taggingservices);?>
                    <label class="col-sm-3  control-label">Tagging services</label>
                    <div class="col-sm-6 ">
                    <input type="checkbox" name="taggingservices[]" value="Flights" <?php if(in_array('Flights', $taggingservices)){ echo "checked";}?>> Flights 
                    <input type="checkbox" name="taggingservices[]" value="Hotels" <?php if(in_array('Hotels', $taggingservices)){ echo "checked";}?>> Hotels 
                    <input type="checkbox" name="taggingservices[]" value="Sightseeing" <?php if(in_array('Sightseeing', $taggingservices)){ echo "checked";}?>> Sightseeing  
                    <input type="checkbox" name="taggingservices[]" value="Transfer" <?php if(in_array('Transfer', $taggingservices)){ echo "checked";}?>>Transfer
                    <input type="checkbox" name="taggingservices[]" value="Visa" <?php if(in_array('Visa', $taggingservices)){ echo "checked";}?>>Visa <input type="checkbox" name="taggingservices[]" value="Insurance" <?php if(in_array('Insurance', $taggingservices)){ echo "checked";}?>>Insurance
                   </div>
                </div>
            <div class="form-group">
        ...
        <div class="form-group warning">
            ...
            <div class="col-sm-6">
                <select class="form-control"name="duration" class="required" id="duration" style="width:275px;" required>
                    ...
                    <option value="10" <?php if ($edit->duration == '10') echo 'selected=selected'; ?>>10Nights+11Days</option>
...
<div class="form-group warning">
    ...
    <div class="col-sm-9" >
        <textarea class="form-control ckeditor" id="" name="comfort" rows="5" placeholder="Enter Comfort Accommodation Description here..." required><?php if (isset($edit->comfort) && $edit->comfort != '') echo $edit->comfort; ?></textarea>
    </div>
</div>
<div class="form-group warning">
    <label class="col-sm-3 control-label" class="col-sm-3 control-label" for="focusedInput">Quality</label>
    <div class="col-sm-9" >
        <textarea class="form-control ckeditor" id="" name="quality" rows="5" placeholder="Enter Quality Accommodation Description here..." required><?php if (isset($edit->quality) && $edit->quality != '') echo $edit->quality; ?></textarea>
    </div>
</div>
<div class="form-group warning">
    <label class="col-sm-3 control-label" class="col-sm-3 control-label" for="focusedInput">Luxury</label>
    <div class="col-sm-9" >
        <textarea class="form-control ckeditor" id="" name="luxury"  placeholder="Enter Luxury Accommodation Description here..." rows="5" required><?php if (isset($edit->luxury) && $edit->luxury != '') echo $edit->luxury; ?></textarea>
    </div>
</div>
