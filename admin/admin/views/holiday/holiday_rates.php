    ...
    <div class="right_col" role="main">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                  <?php if(!empty($result)){ ?>
                 <h2>Edit rates for <b>" <?php echo $hol_info->package_title;  if(!empty($hol_info->package_code)){ echo ' ( Code : '.$hol_info->package_code.' )'; } ?> "</b></h2>
                 <?php } else { ?>
                    <h2>Add rates for <b>" <?php echo $hol_info->package_title;  if(!empty($hol_info->package_code)){ echo ' ( Code : '.$hol_info->package_code.' )'; } ?> "</b></h2>
                     <?php } ?>                    
