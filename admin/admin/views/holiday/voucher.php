...
<html>
  ...
  table td{border-color: #eee;}
  .tabels-content td{ padding-left: 15px; }
    </style>
              ...
              <td>
                              ...
                              <tr>
                                <td>
                                  <h1  style="margin-bottom: -100px;margin-right: 15px; padding: 0; color: #fff;text-align: right;">
                                    <a href="<?php echo str_replace("admin/","",site_url());?>">
                                    <img src="<?php echo base_url()?>public/img/bizzlogo.png"  style=" max-height: 28%;max-width: 28%;-webkit-transform-style: preserve-3d;    color: #000;will-change: width;text-align: center;    margin-bottom: 104px;height: 70px;"/></a>
                                  </h1>
                                </td>
                              </tr>
                            </table>
                              ...
                              <tr>
                                <td valign="top">
                                  <p style="color: #333333; margin: 0; padding: 0;line-height: 1.7;"><br><strong>Dear <?php echo $holiday_booking_info->title.' '.$holiday_booking_info->first_name.' '.$holiday_booking_info->middle_name.' '.$holiday_booking_info->last_name; ?>,</strong><br>
                                    Thank you for booking with BizzHolidays.<br>
                                  ...
                                  <!--   You will receive another email within two working days from your designated travel consultant. It will include more details about your travel arrangements. (We recommend waiting to book flights until you receive this.)<br><br>
                                    Below is a copy of your booking request for this tour:<a href="<?php echo str_replace("admin/","",site_url());?>/holiday/holidaydetails/<?php echo base64_encode('AKBARHOLIDAYSPACKAGECODE'.$holiday_booking_info->holiday_id);?>" target="_blank"><?php echo $holiday_booking_info->package_title; ?></a><br> -->
                ...
                <table width="900" border="0" align="center" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td valign="top"></td>
                    <td bgcolor="#FFFFFF" valign="top">
                      <table width="850" border="1" align="center" cellpadding="5" cellspacing="0" style="border-color: #eee;" class="tabels-content">
                        <tr>
                      ...
                      <table width="850" border="1" align="center" cellpadding="5" cellspacing="0" style="border-color: #eee;" class="tabels-content">
                       ...
                       <!--  <tr>
                        ...
                        <tr>
                          ...
                          <td valign="top"><?php  echo '<i class="fa fa-rupee"></i> '.moneyFormatIndia(round($holiday_booking_info->total_cost));?></td>
                        </tr>
                        <?php } else { ?>
                         <tr>
                        ...
                        <tr>
                          ...
                          <td valign="top">   <?php
                            $tprice=$holiday_booking_info->received_amount;
                    ...
                    <td bgcolor="#FFFFFF" valign="top">
                      <table width="850" border="1" align="center" cellpadding="5" cellspacing="0" style="border-color: #eee;" class="tabels-content">
                        ...
                        <tr>
                          ...
                          <td valign="top">info@bizzholidays.com</td>
                        </tr>
                        <!--  <tr>
                  ...
                  <tr>
                    ...
                    <td bgcolor="#FFFFFF" valign="top">
                      <table width="850" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td valign="top">
                            <p style="color: #333333; margin: 0; padding: 0;line-height: 1.7;">If any of the above details are incorrect, or if you have any questions about your booking request, please email us at info@bizzholidays.com. Please indicate your booking reference number in the message.</p>
                          </td>
                        </tr>
                      </table>
                    </td>
                      ...
                      <table width="850" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td valign="top">
                            ...
                            <p style="color: #333333; margin: 0; padding: 0;line-height: 1.7;">Gorahigo.com</p>
                          </td>
                        </tr>
                      </table>
                    </td>
          ...
          <tr>
            ...
            <!--   <a style="text-decoration:none;" id="print" onclick="coderHakan();return false;" href="JavaScript:void(0);">&nbsp;&nbsp;<img style="width:20px;height:20px;" src="<?php echo base_url();?>public/img/print_Icon.png"/></a>
              <a href="<?php echo base_url(); ?>" title="home"><i class="fa fa-home"></i></a> -->
               <a class="btn btn-primary" style="text-decoration:none;padding: 8px 19px 8px 20px;color: #fff;background-color: #a01d26;
    border-color: #751118;" id="print" onclick="coderHakan();return false;" href="JavaScript:void(0);">
               ...
               <!-- <a class="btn btn-primary" style="text-decoration:none;padding: 8px 19px 8px 20px;color: #fff;background-color: #a01d26;border-color: #751118;" href="<?php echo site_url(); ?>/holiday/holiday_booking_report?>">Back</a> -->
