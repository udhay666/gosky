        ...
        <?php if(!empty($banner)){ ?>
          <form class="form-horizontal" action="<?php echo site_url(); ?>/holiday/update_banner/<?php echo $banner[0]->banner_id; ?>" enctype="multipart/form-data" method="post">						    
           <div class="form-group">
            <label class="col-sm-3 control-label" for="focusedInput">Enter Banner Url</label>
            <div class="col-sm-9">
              <input class="form-control" type="url"  name="bannerurl" value="<?php echo $banner[0]->bannerurl; ?>">
            </div>
          </div>
          <div class="form-group">
