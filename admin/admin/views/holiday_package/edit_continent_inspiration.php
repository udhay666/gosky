     ...
     <div class="row">
       <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
             <label class="col-sm-3 control-label">Promotional Message</label>
             <div class="col-sm-6">
             <input type="text" class="form-control" name="promotional_name" value="<?php echo $ins_continent_list->promotional_name; ?>"/>
                      
              </div>
            </div>
            <?php if(!empty($ins_continent_list->inspiration_img_path)) { ?>
             <div class="form-group">
                <label class="col-sm-3 control-label" for="focusedInput">Current Inspiration Image(2798X740)</label>
                <div class="col-sm-6">
                ...
                <?php } ?> 
            <div class="form-group">
              <label class="col-sm-3 control-label" for="focusedInput">Update New Inspiration Image(2798X740)</label>           
              <div class="col-sm-6 ">
