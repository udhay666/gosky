      ...
      <div class="row">
         ...
         <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
               ...
               <div class="x_content">
                  <br />
                  <form action="<?php echo site_url(); ?>/offers/insert_holiday_images" method="post" class="" role="form" data-parsley-validate enctype="multipart/form-data">
                  ...
                  <ul class="nav nav-tabs nav-dark">
                     <li class="active"><a href="#home2" data-toggle="tab"><strong>Hotel Image List</strong></a></li>
                  </ul>
                        ...
                        <table  id="datatable1" class="table table-striped table-bordered">
                           ...
                           <tbody>
                            <?php if (!empty($holiday_list)) { ?>
                              <?php for ($i = 0; $i < count($holiday_list); $i++) { ?>
                              <tr>
                                 <td><?php echo $i + 1; ?></td>
                                 <td><?php echo $holiday_list[$i]->country ?></td>
                                 <td class="center"><img style="width:200px;height:100px;"src="<?php echo base_url(); echo $holiday_list[$i]->image_path; ?>"/>
                                 </td>
                                 <td><?php if($holiday_list[$i]->status == 1){ echo 'Active';    }else{ echo 'Inactive';   } ?></td>
                                 <td>
                                   <!-- <a href="<?php echo site_url(); ?>/popular/edit_popular/<?php echo $popular_list[$i]->id; ?>" target="_blank">Edit</a><br/> -->
                                    <a href="<?php echo site_url() ?>/offers/holiday_active/<?php echo $holiday_list[$i]->id; ?>/1">Active</a>&nbsp;|&nbsp;
                                    <a href="<?php echo site_url() ?>/offers/holiday_active/<?php echo $holiday_list[$i]->id; ?>/0">Inactive</a>
                                 </td> 
                              </tr>
                              <?php } ?>
                              <?php } else { ?>
