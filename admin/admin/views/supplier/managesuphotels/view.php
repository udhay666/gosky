                 ...
                 if(!empty($hotels)) {
                  ...
                  //  print_r($row);
                    if($row->admin_status > 0) {
                     $status_btn =  '<a href="'.site_url().'/supplier/suphotels_changestatus/'.$row->supplier_hotel_list_id.'" class="btn btn-mini tip" data-original-title="Inactive"><i class="glyphicon glyphicon-ok-sign"></i></a>';
                   } else {
                     $status_btn =  '<a href="'.site_url().'/supplier/suphotels_changestatus/'.$row->supplier_hotel_list_id.'" class="btn btn-mini tip" data-original-title="Active"><img src="'.base_url() .'/public/img/icons/fugue/busy.png" alt=""></a>';
                   }								  
                   echo '<tr>';
                   echo '<td>'.$row->supplier_hotel_list_id.'</td>';
