...
<!--                                                                <td class="table-image">
        ...
        <a class="" href="<?php echo site_url(); ?>/supplier/view_sup_info/<?php echo $supplier_info[$i]->supplier_id; ?>" title="View / Edit" data-rel="tooltip">
            <i class="fa fa-pencil"></i></a>
        </td>
        <td class="center"><a href="<?php echo site_url(); ?>/supplier/get_hotels_by_supplier/<?php echo $supplier_info[$i]->supplier_id; ?>">View Supplier Hotels</a></td>
        <td class="center"><a href="<?php echo site_url(); ?>/supplier/refresh_hotels/<?php echo $supplier_info[$i]->supplier_id; ?>">Refresh Hotels</a></td>
    </tr>
    <?php } ?>
    <?php } else { ?>
