...
$(document).ready(function () {
   ...
   // Ajax call for Active, Inactive, and Blocking Agent accounts
		  ...
		  //  alert($val);
			...
			if(confirm('Are you sure you want to '+ $msg +' this Markup Value?')) {
			 $.ajax({
				...
				success: function (data) {
					window.location = $base_url + 'home/canc_markup_manager';
				}
			});
		}
	});
		  ...
		  //  alert($val);
			...
			if(confirm('Are you sure you want to '+ $msg +' this Markup Value?')) {
			 $.ajax({
				...
				success: function (data) {
					window.location = $base_url + 'home/canc_markup_manager_flights';
				}
			});
		}
	});
		  ...
		  //  alert($val);
			...
			if(confirm('Are you sure you want to '+ $msg +' this Markup Value?')) {
			 $.ajax({
				...
				success: function (data) {
					window.location = $base_url + 'home/canc_markup_manager_bus';
				}
			});
		}
	});
		  ...
		  //alert('hi');
			...
			if(confirm('Are you sure you want to '+ $msg +' this Markup Value?')) {
			 $.ajax({
				...
				success: function (data) {
					window.location = $base_url + 'b2c/bus_markup_manager';
				}
			});
		}
	});
	...
	$('.manageB2BbusMarkupStatus').on('click' , function(){
			...
			if(confirm('Are you sure you want to '+ $msg +' this Markup Value?')) {
			 $.ajax({
				...
				success: function (data) {
					window.location = $base_url + 'b2b/bus_markup_manager';
				}
			});
		}
	});
