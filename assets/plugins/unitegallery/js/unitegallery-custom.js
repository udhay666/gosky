...
function UGFunctions(){
	 ...
	 */
	this.placeImageInsideParent = function(urlImage, objParent, originalWidth, originalHeight, scaleMode, objPadding, objErrorImage){
		var obj = t.getImageInsideParentData(objParent, originalWidth, originalHeight, scaleMode, objPadding);
		//console.log(objErrorImage);
		//set html image:
		var htmlImage = "<img";
		...
		htmlImage += " src=\""+urlImage+"\"";
                if(objErrorImage !== null){
                    htmlImage += " onError=\"this.onerror=null;this.src='"+objErrorImage+"';\""; //Added onError
                }
		htmlImage += ">";
...
function UGSlider(){
	...
	function setImageToSlide(objSlide, objItem, isForce){
		...
		if(currentImage == urlImage && isForce !== true){
			...
			objImage = g_functions.placeImageInsideParent(urlImage, objItemWrapper, objItem.imageWidth, objItem.imageHeight, scaleMode, objPadding, objItem.errorimage);
		...
		var isMobile = t.isMobileMode();
		 ...
		 for(var i=0;i<arrChildren.length;i++){
			 ...
			 if(tagname == "img"){
				 ...
				 var urlErrorImage = objChild.data("errorimage");
				 ...
				 if(typeof(urlThumb) == "undefined")
					 urlThumb = null;
                                ...
                                if(typeof(urlErrorImage) == "undefined")
					 urlErrorImage = null;
				 ...
				 objItem.errorimage = urlErrorImage;
