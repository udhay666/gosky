$(function() {
	function formatF(item) {
	    var cell = '';   
	    cell += "<span class='p-2'><i class='mdi mdi-sleigh'></i></span><span class='p-2'>" + item.label + "</span>"
	    return cell;
	}
	...
	$("#Destination").catcomplete({ 
	    ...
	    source: siteUrl+"home/activity_autolist",   
	    minLength: 0,
	    autoFocus: true,
	    scroll: true,
	...
	$("body").on("focus","#Destination",function(){
	    // $(this).select();
