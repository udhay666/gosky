$(function() {
	function formatF(item) {
	    var cell = '';   
	    cell += "<span class='p-2'><i class='mdi mdi-truck'></i></span><span class='p-2'>" + item.label + "</span>"
	    return cell;
	}
	...
	$("#tranferCity").catcomplete({
	    delay: 0,
	    // source: availableTags,
	    source: siteUrl+"home/transfer_city_list",   
	    minLength: 0,
	    autoFocus: true,
	    scroll: true,
	...
	$("body").on("focus","#tranferCity",function(){
	    // $(this).select();
