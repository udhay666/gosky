$(document).ready(function()
    {	
        ...
        $('#result').html(data.transfer_search_result);
        ...
        var prices = $(".TransferInfoBox").map(function() {
        ...
        var durations = $(".TransferInfoBox").map(function() {
     ...
     // console.log(VehicleString);
        ...
        for (var i = 0, l = api_array.length; i < l; i++) { //alert(i);
            ...
            $.ajax({
                url: siteUrl+'transfer/transfer_availability',				
                ...
                $.ajax({
                    url: siteUrl+'transfer/fetch_results', 
