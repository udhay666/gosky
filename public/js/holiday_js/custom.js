...
(function ($, window, Modernizr, document, CONFIG) {
	...
	/* ---------------------------------------------------------------------- */
		...
		OnePage.DEFAULTS = {
			easing: 'easeInOutExpo',
			animatedElem: true,
			queryLoader: false, /* queryLoader: true,  for percentage loader*/
			duration: 1200
		}
		...
		OnePage.prototype = {
			init: function (options) {
				var self = this, $window = $(window),
					// windowHeight = !Modernizr.touch ? $(window).height()-188-150 : '450px' || '400px',
					windowHeight = $window.height()-188-150,
			...
			sectionAnimate: function (section) {
				...
				$('html, body').stop(true, true).animate({
					scrollTop: section.offset().top - 0 + "px"
				}, {
			...
			stickyHeader: function (win) {
				...
				$(win).scrollTop() > 0 ? this.navbar.addClass('shrink-head') : this.navbar.removeClass('shrink-head');
			},
...
;(function(e,t,n,r) {
    function u(t,n) {
        ...
        ,o,n);this._defaults=o;this._name=s;this.init()}

    function a() {
        return!!("ontouchstart"in t)}

    function f() {
        var e=n.body||n.documentElement;var t=e.style;var r="transition";if(typeof t[r]=="string") {
            return true}
    ...
    var s="tooltipster",o= {
        animation: "fade",arrow:true,arrowColor:"",content:"",delay:200,fixedWidth:0,maxWidth:0,functionInit:function(e,t) {
        }
    ...
    var c=a();e(t).on("mousemove.tooltipster",function() {
        c=false;e(t).off("mousemove.tooltipster")}

    );u.prototype= {
        init: function() {
            var t=e(this.element);
            var i=this;var s=true;if(!i.options.touchDevices&&c) {
                s=false}
            ...
            if(s) {
                ...
                var u=i.options.functionInit(t,o);if(u)o=u;t.data("tooltipsterContent",o);t.removeAttr("title");if(i.options.iconDesktop&&!c||i.options.iconTouch&&c) {
                    var a=i.options.iconTheme;var f=e('<span class="'+a.replace(".","")+'"></span>');f.data("tooltipsterContent",o).append(i.options.icon).insertAfter(t);t.data("tooltipsterIcon",f);t=f}
                    ...
                    if(i.options.trigger=="hover") {
                        t.on("mouseenter.tooltipster",function() {
                            ...
                            t.on("mouseleave.tooltipster",function() {
                                var n=t.data("tooltipster");var s=false;if(n!==r&&n!=="") {
                                        ...
                                        if(s) {
                                            if(i.options.interactiveAutoClose) {
                                                n.find("select").on("change",function() {
                                                    ...
                                                    var n=e(t.target);if(n.parents(".tooltipster-base").length===0||n.hasClass("tooltipster-base")) {
                                                        i.hideTooltip()}
        ...
        ,showTooltip: function(t) {
            ...
            var i=this;if(n.data("tooltipsterIcon")!==r) {
            ...
            if(!n.hasClass("tooltipster-disable")) {
                if(e(".tooltipster-base").not(".tooltipster-dying").length>0&&i.options.onlyOne) {
                    e(".tooltipster-base").not(".tooltipster-dying").not(n.data("tooltipster")).each(function() {
                        e(this).addClass("tooltipster-kill");var t=e(this).data("origin");t.data("plugin_tooltipster").hideTooltip()}
                ...
                n.clearQueue().delay(i.options.delay).queue(function() {
                    i.options.functionBefore(n,function() {
                        if(n.data("tooltipster")!==r&&n.data("tooltipster")!=="") {
                            var t=n.data("tooltipster");if(!t.hasClass("tooltipster-kill")) {
                                var s="tooltipster-"+i.options.animation;t.removeClass("tooltipster-dying");if(l) {
                                    t.clearQueue().addClass(s+"-show")}

                                if(i.options.timer>0) {
                                    var o=t.data("tooltipsterTimer");clearTimeout(o);o=setTimeout(function() {
                                ...
                                if(i.options.touchDevices&&c) {
                                    e("body").bind("touchstart",function(t) {
                                        if(i.options.interactive) {
                                            var n=e(t.target);var r=true;n.parents().each(function() {
                                                if(e(this).hasClass("tooltipster-base")) {
                                                    r=false}
                                            }

                                            );if(r) {
                                                i.hideTooltip();e("body").unbind("touchstart")}
                                        }
                            ...
                            i.options._bodyOverflowX=e("body").css("overflow-x");e("body").css("overflow-x","hidden");var u=i.getContent(n);var a=i.options.theme;var h=a.replace(".","");var s="tooltipster-"+i.options.animation;var p="-webkit-transition-duration: "+i.options.speed+"ms; -webkit-animation-duration: "+i.options.speed+"ms; -moz-transition-duration: "+i.options.speed+"ms; -moz-animation-duration: "+i.options.speed+"ms; -o-transition-duration: "+i.options.speed+"ms; -o-animation-duration: "+i.options.speed+"ms; -ms-transition-duration: "+i.options.speed+"ms; -ms-animation-duration: "+i.options.speed+"ms; transition-duration: "+i.options.speed+"ms; animation-duration: "+i.options.speed+"ms;";var d=i.options.fixedWidth>0?"width:"+Math.round(i.options.fixedWidth)+"px;": "";
                            var v=i.options.maxWidth>0?"max-width:"+Math.round(i.options.maxWidth)+"px;": "";
                            var m=i.options.interactive?"pointer-events: auto;": "";
                            var t=e('<div class="tooltipster-base '+h+" "+s+'" style="'+d+" "+v+" "+m+" "+p+'"></div>');var g=e('<div class="tooltipster-content"></div>');g.html(u);t.append(g);t.appendTo("body");n.data("tooltipster",t);t.data("origin",n);i.positionTooltip();i.options.functionReady(n,t);if(l) {
                                t.addClass(s+"-show")}

                            else {
                                t.css("display","none").removeClass(s).fadeIn(i.options.speed)}

                            var y=u;var b=setInterval(function() {
                                var r=i.getContent(n);if(e("body").find(n).length===0) {
                                    t.addClass("tooltipster-dying");i.hideTooltip()}

                                else if(y!==r&&r!=="") {
                                    y=r;t.find(".tooltipster-content").html(r);if(i.options.updateAnimation) {
                                        if(f()) {
                                            t.css( {
                                                width: "","-webkit-transition":"all "+i.options.speed+"ms, width 0ms, height 0ms, left 0ms, top 0ms","-moz-transition":"all "+i.options.speed+"ms, width 0ms, height 0ms, left 0ms, top 0ms","-o-transition":"all "+i.options.speed+"ms, width 0ms, height 0ms, left 0ms, top 0ms","-ms-transition":"all "+i.options.speed+"ms, width 0ms, height 0ms, left 0ms, top 0ms",transition:"all "+i.options.speed+"ms, width 0ms, height 0ms, left 0ms, top 0ms"
                                            }

                                            ).addClass("tooltipster-content-changing");setTimeout(function() {
                                                t.removeClass("tooltipster-content-changing");setTimeout(function() {
                                                    t.css( {
                                                        "-webkit-transition": i.options.speed+"ms","-moz-transition":i.options.speed+"ms","-o-transition":i.options.speed+"ms","-ms-transition":i.options.speed+"ms",transition:i.options.speed+"ms"
                                                    }
                            ...
                            ,200);if(i.options.timer>0) {
                                var o=setTimeout(function() {
                                    t.data("tooltipsterTimer",r);i.hideTooltip()}

                                ,i.options.timer+i.options.speed);t.data("tooltipsterTimer",o)}
        ...
        ,hideTooltip: function(t) {
            ...
            var s=n.data("tooltipster");if(s===r) {
                s=e(".tooltipster-dying")}

            n.clearQueue();if(s!==r&&s!=="") {
                var o=s.data("tooltipsterTimer");if(o!==r) {
                    clearTimeout(o)}

                var u="tooltipster-"+i.options.animation;if(l) {
        ...
        ,positionTooltip: function(n) {
            ...
            var o=this;if(s.data("tooltipsterIcon")!==r) {
                s=s.data("tooltipsterIcon")}

            if(s.data("tooltipster")!==r&&s.data("tooltipster")!=="") {
                var u=s.data("tooltipster");u.css("width","");var a=e(t).width();var f=s.outerWidth(false);var l=s.outerHeight(false);var c=u.outerWidth(false);var h=u.innerWidth()+1;var p=u.outerHeight(false);var d=s.offset();var v=d.top;var m=d.left;var g=r;if(s.is("area")) {
                    var y=s.attr("shape");var b=s.parent().attr("name");var w=e('img[usemap="#'+b+'"]');var E=w.offset().left;var S=w.offset().top;var x=s.attr("coords")!==r?s.attr("coords").split(","): r;
                    if(y=="circle") {
                        var T=parseInt(x[0]);var N=parseInt(x[1]);var C=parseInt(x[2]);l=C*2;f=C*2;v=S+N-C;m=E+T-C}

                    else if(y=="rect") {
                        var T=parseInt(x[0]);var N=parseInt(x[1]);var k=parseInt(x[2]);var L=parseInt(x[3]);l=L-N;f=k-T;v=S+N;m=E+T}

                    else if(y=="poly") {
                        var A=[];var O=[];var M=0,_=0,D=0,P=0;var H="even";for(i=0;i<x.length;i++) {
                            var B=parseInt(x[i]);if(H=="even") {
                                if(B>D) {
                                    D=B;if(i===0) {
                                        M=D}
                                }
                        ...
                        l=w.outerHeight(false);f=w.outerWidth(false);v=S;m=E}
                }

                if(o.options.fixedWidth===0) {
                    u.css( {
                        width: Math.round(h)+"px","padding-left":"0px","padding-right":"0px"
                    }

                    )}

                var j=0,F=0,I=0;var q=parseInt(o.options.offsetY);var R=parseInt(o.options.offsetX);var U="";function z() {
                    var n=e(t).scrollLeft();if(j-n<0) {
                        var r=j-n;j=n;u.data("arrow-reposition",r)}

                    if(j+c-n>a) {
                        var r=j-(a+n-c);j=a+n-c;u.data("arrow-reposition",r)}
                }

                function W(n,r) {
                    if(v-e(t).scrollTop()-p-q-12<0&&r.indexOf("top")>-1) {
                        o.options.position=n;g=r}

                    if(v+l+p+12+q>e(t).scrollTop()+e(t).height()&&r.indexOf("bottom")>-1) {
                        o.options.position=n;g=r;I=v-p-q-12}
                }

                if(o.options.position=="top") {
                    var X=m+c-(m+f);j=m+R-X/2;I=v-p-q-12;z();W("bottom","top")}

                if(o.options.position=="top-left") {
                    j=m+R;I=v-p-q-12;z();W("bottom-left","top-left")}

                if(o.options.position=="top-right") {
                    j=m+f+R-c;I=v-p-q-12;z();W("bottom-right","top-right")}

                if(o.options.position=="bottom") {
                    var X=m+c-(m+f);j=m-X/2+R;I=v+l+q+12;z();W("top","bottom")}

                if(o.options.position=="bottom-left") {
                    j=m+R;I=v+l+q+12;z();W("top-left","bottom-left")}

                if(o.options.position=="bottom-right") {
                    j=m+f+R-c;I=v+l+q+12;z();W("top-right","bottom-right")}

                if(o.options.position=="left") {
                    j=m-R-c-12;F=m+R+f+12;var V=v+p-(v+s.outerHeight(false));I=v-V/2-q;if(j<0&&F+c>a) {
                        var J=parseFloat(u.css("border-width"))*2;var K=c+j-J;u.css("width",K+"px");p=u.outerHeight(false);j=m-R-K-12-J;V=v+p-(v+s.outerHeight(false));I=v-V/2-q}

                    else if(j<0) {
                        j=m+R+f+12;u.data("arrow-reposition","left")}
                }

                if(o.options.position=="right") {
                    j=m+R+f+12;F=m-R-c-12;var V=v+p-(v+s.outerHeight(false));I=v-V/2-q;if(j+c>a&&F<0) {
                        var J=parseFloat(u.css("border-width"))*2;var K=a-j-J;u.css("width",K+"px");p=u.outerHeight(false);V=v+p-(v+s.outerHeight(false));I=v-V/2-q}

                    else if(j+c>a) {
                        j=m-R-c-12;u.data("arrow-reposition","right")}
                }

                if(o.options.arrow) {
                    var Q="tooltipster-arrow-"+o.options.position;if(o.options.arrowColor.length<1) {
                        var G=u.css("background-color")}

                    else {
                        var G=o.options.arrowColor}

                    var Y=u.data("arrow-reposition");if(!Y) {
                        Y=""}

                    else if(Y=="left") {
                        Q="tooltipster-arrow-right";Y=""}

                    else if(Y=="right") {
                        Q="tooltipster-arrow-left";Y=""}

                    else {
                        Y="left:"+Math.round(Y)+"px;"}

                    if(o.options.position=="top"||o.options.position=="top-left"||o.options.position=="top-right") {
                        var Z=parseFloat(u.css("border-bottom-width"));var et=u.css("border-bottom-color")}

                    else if(o.options.position=="bottom"||o.options.position=="bottom-left"||o.options.position=="bottom-right") {
                        var Z=parseFloat(u.css("border-top-width"));var et=u.css("border-top-color")}

                    else if(o.options.position=="left") {
                        var Z=parseFloat(u.css("border-right-width"));var et=u.css("border-right-color")}

                    else if(o.options.position=="right") {
                        var Z=parseFloat(u.css("border-left-width"));var et=u.css("border-left-color")}
                    ...
                    var tt="";if(Z!==0) {
                        var nt="";var rt="border-color: "+et+";";if(Q.indexOf("bottom")!==-1) {
                ...
                u.css( {
                    top: Math.round(I)+"px",left:Math.round(j)+"px"
                }
        ...
        ,getContent: function(t) {
            ...
            n=e(e.parseHTML("<div>"+n+"</div>")).html();return n}
    }
    ...
    ;e.fn[s]=function(t) {
        if(t&&t==="setDefaults") {
            ...
            if(typeof t==="string") {
                var n=this;var i=arguments[1];var a=null;if(n.data("plugin_tooltipster")===r) {
                    var f=n.find("*");n=e();f.each(function() {
                ...
                n.each(function() {
                    switch(t.toLowerCase()) {
                        case"show": e(this).data("plugin_tooltipster").showTooltip();
                        break;case"hide": e(this).data("plugin_tooltipster").hideTooltip();
                        break;case"disable": e(this).addClass("tooltipster-disable");
                        break;case"enable": e(this).removeClass("tooltipster-disable");
                        break;case"destroy": e(this).data("plugin_tooltipster").hideTooltip();
                        var s=e(this).data("tooltipsterIcon");if(s)s.remove();e(this).attr("title",n.data("tooltipsterContent")).removeData("plugin_tooltipster").removeData("tooltipsterContent").removeData("tooltipsterIcon").off(".tooltipster");break;case"elementicon": a=e(this).data("tooltipsterIcon");
                        a=a?a[0]: r;
                        return false;case"update": var o=i;
                        if(e(this).data("tooltipsterIcon")===r) {
                            e(this).data("tooltipsterContent",o)}

                        else {
                            var u=e(this).data("tooltipsterIcon");u.data("tooltipsterContent",o)}

                        break;case"reposition": e(this).data("plugin_tooltipster").positionTooltip();
                        break;case"val": a=e(this).data("tooltipsterContent");
        ...
        t.addEventListener("orientationchange",function() {
            if(e(".tooltipster-base").length>0) {
                e(".tooltipster-base").each(function() {
                    var t=e(this).data("origin");t.data("plugin_tooltipster").hideTooltip()}
    ...
    e(t).on("scroll.tooltipster",function() {
        var t=e(".tooltipster-base").data("origin");if(t) {
            t.tooltipster("reposition")}
    }

    );e(t).on("resize.tooltipster",function() {
        var t=e(".tooltipster-base").data("origin");if(t!==null&&t!==r) {
            t.tooltipster("reposition")}
    }
...
(function () {
    ...
    function getGridSize() {
	  ...
	  ( (window.innerWidth || document.documentElement.clientWidth) < 1024) ? 4 : 8;
	}
    ...
    $window.load(function () {
        //Carousel
        $('.collections .flexslider').flexslider({
            animation: "slide",
            animationLoop: false,
            itemWidth: 70,
            // slideshowSpeed: 7000,
        ...
        //Flexslider
        $('.hot-offers .flexslider').flexslider({
            animation: "slide",
            controlNav: true

        });
        $('.inspiration .flexslider').flexslider({
            animation: "slide",
            // itemWidth: 600,
            itemHeight: 200,
            smoothHeight: false,
        ...
        $('.our-clients .flexslider').flexslider({
            animation: "slide",
            animationLoop: true,
            itemWidth: 350,
            // slideshowSpeed: 7000,
        ...
        $('.hol_details .flexslider').flexslider({
            animation: "slide",
            animationLoop: true,
            // itemWidth: 600,
            // itemHeight: 400,
...
// $('#layerslider-container').layerSlider({
//     // slideDirection          : 'left',
//     // slideDelay              : 4000,
//     // durationIn              : 1000,
//     // durationOut             : 1000,
...
// });    
    ...
    $('.search-field').each(function () {
        $(this).click(function () {
            ...
            $(this).parent().parent().find('.dropdown-search').toggle();
        });
    });
...
//$('.htl-childAge1, .htl-childAge2, .htl-childAge3, .age').hide();
$('.selectchildAge').change(function(){
//alert($(this).val());
$('.age').show();
        if($(this).val() == '1'){
            //'alert('hii');
            $(this).parent('.quant').parent('.htl-selectChild').parent('.search-field2').find('.htl-age').hide();
            $(this).parent('.quant').parent('.htl-selectChild').parent('.search-field2').find('.htl-childAge1').show();
        }
        if($(this).val() == '2'){
            $(this).parent('.quant').parent('.htl-selectChild').parent('.search-field2').find('.htl-age').hide();
            $(this).parent('.quant').parent('.htl-selectChild').parent('.search-field2').find('.htl-childAge1, .htl-childAge2').show();
        }
        if($(this).val() == '3'){
            $(this).parent('.quant').parent('.htl-selectChild').parent('.search-field2').find('.htl-age').show();
        }
        if($(this).val() == '0'){
            $(this).parent('.quant').parent('.htl-selectChild').parent('.search-field2').find('.htl-age').hide();
            $('.age').hide();
   ...
   //datepicker code
    ...
    var checkinB2 = $('#dpb2').datepicker({
        ...
        onRender: function(date) {
            // return date.valueOf() < now.valueOf() ? 'disabled' : '';
            return date.valueOf() <= checkinB1.date.valueOf() ? 'disabled' : '';
        }
    }).on('changeDate', function(ev) {
        checkinB2.hide();
	...
	//alert('loading');
	var checkinDPMCa = $('.dpicker').datepicker({
		//alert('fvd');
		minDate: 0,
		maxDate: '+12M',
		numberOfMonths: 1,
    ...
    var checkinFj = $('#dpf1').datepicker({
        ...
        $tripdat=$('input[name=tripType]:checked', '#hotel-tab').val();console.log($tripdat);
        if($tripdat=='S'){
        	$('#dpf2').val('');
        }
        checkinFj.hide();
    ...
    var checkoutFr = $('#dpf2').datepicker({
		minDate: 0,
		maxDate: '+12M',
        dateFormat: 'dd/mm/yy',
        onRender: function(date) {
   ...
   /* var checkinHol = $('#dph1').datepicker({
		minDate: 0,
		maxDate: '+12M',
        dateFormat: 'dd/mm/yy',
        onRender: function(date) {
        ...
        if (ev.date.valueOf() > checkoutHol.date.valueOf()) {
            var newDate = new Date(ev.date)
            newDate.setDate(newDate.getDate() + 1);
            checkoutHol.setValue(newDate);
        }
        checkinHol.hide();
        $('#dph2')[0].focus();
    }).data('datepicker');
    var checkoutHol = $('#dph2').datepicker({
		minDate: 0,
		maxDate: '+12M',
        dateFormat: 'dd/mm/yy',
        onRender: function(date) {
    	...
    	if (ev.date.valueOf() > checkinHol.date.valueOf()) {
            var newDate = new Date(ev.date)
            newDate.setDate(newDate.getDate() + 1);
            checkinHol.setValue(newDate);
        }
        checkoutHol.hide();
    }).data('datepicker'); */
