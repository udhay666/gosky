$(document).ready(function()
    {
        ...
        { //alert($a);
         ...
         {*/
            $.ajax({
                ...
                data: 'callBackId=' + api_array[$a]+'&uniqueRefNo='+uniqueRefNo,
                dataType: 'json',
                type: 'POST',
                success: function(data)
                {
                    ...
                    if (data.results == 'success')
                    {
                        ...
                        load_search_results($a,uniqueRefNo);
                    }
        ...
        function load_search_results($a,$uniqueRefNo)
        {
       
            $.ajax({
                url: siteUrl + 'hotels/fetch_results',
                data: 'count=' + $a+'&uniqueRefNo='+$uniqueRefNo,
                dataType: 'json',
                type: 'POST',
                success: function(data)
                { 
