$(document).ready(function()
    {
        ...
        { //alert($a);
         ...
         {*/
            $.ajax({
                ...
                data: 'callBackId=' + api_array[$a]+'&uniqueRefNo='+uniqueRefNo+'&sess_id='+sess_id,
                dataType: 'json',
                type: 'POST',
                success: function(data)
                {
                    ...
                    if (data.results == 'success')
                    {
                        ...
                        load_search_results($a,uniqueRefNo,sess_id);
                    }
        ...
        function load_search_results($a,$uniqueRefNo,$sess_id)
        {
       
            $.ajax({
                url: siteUrl + 'hotels/fetch_results',
                data: 'count=' + $a+'&uniqueRefNo='+$uniqueRefNo+'&sess_id='+$sess_id,
                dataType: 'json',
                type: 'POST',
                success: function(data)
                { 
