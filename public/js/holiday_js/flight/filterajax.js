 ...
 */
 ...
 { 
    ...
    {		
        ...
        if(($dataprice<=$maxPr && $dataprice>=$minPr) && ($datadeparture<=$maxTime && $datadeparture>=$minTime) && ($dataduration<=$maxDuration && $dataduration>=$minDuration) && stopShow && airlineShow)
    ...
    $.post(siteUrl+"flights/searchresult_ajax", { sessionId: ""+$sessionId, minPrice: ""+$minPr, maxPrice: ""+$maxPr, stops: ""+$stopShow, airlines: ""+$airlineShow, minTime: ""+$minTime, maxTime: ""+$maxTime, sortBy: ""+$sort_data, order: ""+$sort_order }, 
