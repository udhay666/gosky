...
<?php  $pass_info = $this->session->userdata('passenger_info');  ?>
<?php  $search_details = $this->session->userdata('search_details');  ?>
...
<section id="pack-section" class="pack-section" style="background: #1c1d22;">
        ...
        <div class="row">
          <div class="col-sm-4">
            <div class="form-group">
              ...
              <input type="email" name="user_email" class="form-control" id="user_email" value="<?php echo $pass_info['user_email'];?>" placeholder="Enter your Email" autocomplete="off"/>
          ...
          <div class="col-sm-4">
            <div class="form-group">
              ...
              <input type="text" name="user_mobile" class="form-control" id="user_mobile" value="<?php echo $pass_info['user_mobile'];?>" placeholder="Enter your Mobile No" autocomplete="off"/>
            </div>
          </div>
          <div class="col-sm-4">
            <div class="form-group">
              <label class="control-label" for="user_city">City</label>
              <input type="text" name="user_city" value="<?php echo $pass_info['user_city'];?>" class="form-control" placeholder="Enter your City" id="user_city" autocomplete="off"/>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-4">
            <div class="form-group">
              ...
              <input type="text" name="user_pincode" value="<?php echo $pass_info['user_pincode'];?>" class="form-control" placeholder="Enter your Postal Code" id="user_pincode" autocomplete="off"/>
            </div>
          </div>
          <div class="col-sm-4">
            <div class="form-group">
              <label class="control-label" for="user_state">State</label>
              <input type="text" name="user_state" value="<?php echo $pass_info['user_state'];?>" class="form-control" placeholder="Enter your State" id="user_state" autocomplete="off"/>
            </div>
          </div>
          <div class="col-sm-4">
            <div class="form-group">
        ...
        <div class="row">
          <div class="col-sm-8">
            <div class="form-group">
              ...
              <textarea class="form-control" name="address" placeholder="Enter your contact address" id="user_address" style="height: 80px;min-height: 80px;" autocomplete="off"><?php echo $pass_info['address'];?></textarea>
            </div>
          </div>
          <div class="col-sm-4">
            <div class="form-group">
              <label class="control-label" for="user_comment">Comment</label>
              <textarea class="form-control" name="comment" id="user_comment" placeholder="Enter your Comment"  style="height: 80px;min-height: 80px;" autocomplete="off"><?php echo $pass_info['comment'];?></textarea>
            </div>
          </div>
        </div>
      </section>
    ...
    <section id="Traveller" class="shadow-box white-container container page">
      <section class="section">
          ...
          <div class="row checkname">
            <div class="col-sm-12">
              ...
              <div class="col-sm-2 form-group">
                <select class="form-control checktitle2" name="title[]" style="padding-right: 0;padding-left: 10px;">
                  <option value=""></option>
        ...
        <div class="row2">
         ...
         <div class="row2">
         <?php if($pass_info['childswithoutbed_no']>0){ ?>
          <h6>Child(s) (Without Bed)</h6>
          <?php for($k=0;$k<$pass_info['childswithoutbed_no']&&($pass_info['passengertype'][$i]=='childwithoutbed');$i++,$k++){ ?>
          <div class="row checkname">
            <div class="col-sm-12">
              <div class="col-sm-1">Child <?php echo ($k+1);?></div>
              <div class="col-sm-2 form-group">
    ...
    <section id="Package" class="shadow-box white-container container page">
      <section class="section">
        ...
        <div class="row2 table-responsive ">
          <table align="" class="table table-striped table-bordered ">
            <tr>
             ...
             <tr>
              ...
              <td><?php echo $pass_info['childswithoutbed_no']; ?></td>
          ...
          <input type="hidden" name="package_code" value="<?php echo $pass_info['package_code']; ?>" />
          ...
          <input type="hidden" name="childswithoutbed_no" value="<?php echo $pass_info['childswithoutbed_no']; ?>" />
          <input type="hidden" name="infants_no" value="<?php echo $pass_info['infants_no']; ?>" />
          <input type="hidden" id="original_cost" name="total_cost" value="<?php echo $pass_info['total_cost'];?>"/>
        </div>
        <?php
  ...
  <div class="bottom-line"></div>
         <div class="row">
         <div class="col-sm-4">             
            <input type="text" id="promo_code" name="promo_code" placeholder="Enter Promotional Code" value="" class="form-control" autocomplete="off" />     
      </div>
       <div class="col-sm-2">
