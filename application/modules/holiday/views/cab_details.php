            ...
            <div class="flex-wrap-viewport">
               <div class="flex-viewport" style="overflow: hidden; position: relative;">
                  <ul class="slides" style="width: 800%; transition-duration: 0s; transform: translate3d(-4px, 0px, 0px);">
                     <?php $str =$result->itinerarycab_image;
                     ?>
         ...
         <div class="booking-form">
            ...
            <form id="booking-side-form" method="post" action="" data-min="0" data-max="0">
               ...
               <a href="<?php echo site_url(); ?>holiday/holidaydetails/<?php echo  base64_encode('BIZZHOLIDAYSPACKAGECODE'.$result->holiday_id); ?>" style="font-size: 36px;margin-top: 20px;" class="booking-find-link">
                  <h1><?php echo strtoupper($result->itinerarycab); ?></h1>
               </a>
               ...
               <div class="row">
                  ...
                  <button type="button" style="background-color: #FFBF00;color:#203FB3;margin-left:103px;"  data-val='<?php echo $result->itinerarycab; ?>' data-code="<?php echo $result->holiday_id; ?>"  data-toggle="modal" data-target="#myModal">ENQUIRE NOW</a>
               </div>
               <br>
...
<section class="page" id="overview">
   <section class="section" id="overview2">
      <div class="col-sm-9 col-xs-12">
         ...
         <h1>Cab Details</h1>
         <p>&nbsp;&nbsp;<?php echo $result->itinerarycab; ?>
         
         
         <p>Pick Up/Drop Off &nbsp;&nbsp; <?php echo $result->itinerarypick; ?>/<?php echo $result->itinerarydrop; ?></p>
         <p>Seats &nbsp;&nbsp;<?php echo $result->itineraryseats; ?></p>

         <p>Cab Inclusion &nbsp;&nbsp;<?php echo $result->itinerarytinclusion; ?></p>
         <p>Cab Exclusion &nbsp;&nbsp;<?php echo $result->itinerarycab_exclusion; ?></p>
      </div>
   </section>
</section>
