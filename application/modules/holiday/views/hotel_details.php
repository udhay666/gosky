...
<section class="h-details page" id="home">
   <section class="section padding-off imgbanner" >
      <div class="hol_details" id="layerslider-container3" style="margin-bottom: -5px;margin-top: -6px;" >
            ...
            <div class="flex-wrap-viewport">
               <div class="flex-viewport" style="overflow: hidden; position: relative;">
                  <ul class="slides" style="width: 800%; transition-duration: 0s; transform: translate3d(-4px, 0px, 0px);">
                     <?php $str =$result->itineraryimage;?>
                     <li class="clone" aria-hidden="true" style="width: 1349px; float: left; display: block;">

                        <img alt="yhyhh" class="ls-bg" src="<?php echo site_url() ?>admin/<?php echo $str; ?>" style="height: 528px;" draggable="false"/>
                     </li>
         ...
         <div class="top-text">
            <span class="top-text-name">sss</span>
            <span class="top-text-duration">vvv</span>        
         </div>
      </div>
   </section><?php //print_r($result);?>
         ...
         <div class="booking-form">
            <header style="height: 63px;">
               <div class="price" style="margin-top: -10px;">
                  <span><span style="font-size: 11px;color:#FFBF00">Price on Twin sharing from</span><span id="priceheader" style="font-size: 22px;color:#FFBF00"> <i class="fa fa-rupee"></i> <?php echo $result->itineraryrate; ?></span></span>
               </div> 
            </header>
           
            <form id="booking-side-form" method="post" action="" data-min="0" data-max="0">
               <input type="hidden"  name="holiday_id" id="holiday_id" value="<?php echo $result->holiday_id; ?>">
               ...
               <a href="<?php echo site_url(); ?>holiday/holidaydetails/<?php echo  base64_encode('BIZZHOLIDAYSPACKAGECODE'.$result->holiday_id); ?>" style="font-size: 36px;margin-top: 20px;" class="booking-find-link">
                  <h1><?php echo strtoupper($result->itineraryhotel); ?></h1>
               </a>
               <span style="position: relative;top: -10px">
               <?php echo " Date Available / ".($result->itinerarydate);?>
               </span>
               <div class="row">
                  
                  <button type="button" style="background-color: #FFBF00;color:#203FB3;margin-left:103px;"  data-val='<?php echo $result->itineraryhotel; ?>' data-code="<?php echo $result->holiday_id; ?>"  data-toggle="modal" data-target="#myModal">ENQUIRE NOW</a>
               </div>
               <br>
...
<section class="page" id="overview">
   <section class="section" id="overview2">
      <div class="col-sm-9 col-xs-12">
         ...
         <h1>Hotel Details</h1>
         <p><?php echo $result->itineraryhotel; ?> 
         
         <span class="star star<?php echo $result->itinerarystar; ?>"></span>
         ( (₹) <?php echo $result->itineraryrate; ?>/-) 
         <p>Room Name <?php echo $result->itineraryroom; ?></p>
         <p>Hotel Inclusion <?php echo $result->itineraryinclusion; ?></p>

         <p>Hotel Exclusion<?php echo $result->itineraryexclusion; ?></p>
      </div>
   </section>
</section>
