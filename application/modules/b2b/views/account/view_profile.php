  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-12 col-md-12 mx-auto">
        <form action="<?php echo site_url();?>b2b/update_profile" method="post"  enctype="multipart/form-data" class="" data-parsley-validate>
              ...
              <div class="col-md-12">
                <div class="row form-group">
                  ...
                  <div class="col-md-4">
                    ...
                    <small class="small-font">(B2B No will be generated, Ex:- MTPC1234)</small>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-md-4">
                    ...
                    <a href="<?php echo site_url();?>b2b/change_password" title="Click here to Reset b2b password" data-rel="tooltip" class="btn btn-primary push-top-5"><i class="mdi mdi-undo"></i>Reset Password</a>
            ...
            <div class="white-container">
              <div class="row form-group">
                ...
                <div class="col-md-4">
                  ...
                  <small class="small-font">(No permission to update B2B Number)</small>
                </div>
              </div>
              <div class="row form-group">
              ...
              <div class="row form-group">
                ...
                <div class="col-md-4">
                  <img class="grayscale" alt="b2b Logo" src="<?php echo base_url().'admin/'.$agent_info->agent_logo; ?>" height="100px" width="100px" align="middle">
                </div>
              </div>
              <?php } ?>
              <div class="row">
            ...
            <div class="white-container">
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  ...
                  <a href="<?php echo site_url() ?>b2b/dashboard" title="Click here to go back" class="btn btn-danger"><i class="mdi mdi-undo"></i> Go Back</a>
                </div>
              </div>
            </div>
          </div>
