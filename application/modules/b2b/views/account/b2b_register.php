...
<style>
  section-agent {
  background-image: url("../images/bg/bg-agent.jpg");
  }
</style>
<section class="section-padding inner-page" style="margin-top:100px;">
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-12 col-md-12 mx-auto">
        <form action="<?php echo site_url();?>b2b/b2b_register" class="form-horizontal" method="post" enctype="multipart/form-data" data-parsley-validate>
              ...
              <div class="row form-group">
                ...
                <div class="col-md-6">
                  <select class="form-control" name="country" required>
                    ...
                    <?php
                    // echo 123;print_r($country_list);exit;
            ...
            <div class="white-container">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <a href="<?php echo site_url() ?>b2b" title="Click here to go back" class="btn btn-danger"><i class="mdi mdi-undo"></i> Cancel</a>
                </div>
              </div>
            </div>
          </div>
