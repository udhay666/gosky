  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-12 col-md-12 mx-auto">
        <form action="<?php echo site_url();?>b2b/my_bookings/cabs" method="get" enctype="multipart/form-data" class="form-horizontal" data-parsley-validate>
...
<!--                     <td><?php echo $car_booking_summary[$j]->Ticket_Number; ?></td>
 -->
                    ...
                    <td>
                            ...
                            <a target="_blank" href="<?php echo site_url(); ?>car/car_eticket/<?php echo $car_booking_summary[$j]->uniqueRefNo; ?>/<?php  if(!empty($RefIDs)) { echo implode('/',$RefIDs); } else { echo ''; }   ; ?>"><i class="mdi mdi-ticket"></i>E-Ticket</a>
                        </td>
                  </tr>
                  <?php } ?>
                  <?php } ?>
