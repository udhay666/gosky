  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-12 col-md-12 mx-auto">
        <form action="<?php echo site_url();?>b2b/my_bookings/activity" method="get" enctype="multipart/form-data" class="form-horizontal" data-parsley-validate>
                  ...
                  <tr>
                    ...
                    <?php $RefIDs = array_filter(explode(',',$activity_booking_summary[$j]->BookingId)); ?>
                        <td>
                            ...
                            <a target="_blank" href="<?php echo site_url(); ?>activity/activity_eticket/<?php  if(!empty($RefIDs)) { echo implode('/',$RefIDs); } else { echo ''; }   ; ?>/<?php echo $activity_booking_summary[$j]->uniqueRefNo; ?>/">E-Ticket</a>
                        </td>
                  </tr>
                  <?php } ?>
                  <?php } ?>
