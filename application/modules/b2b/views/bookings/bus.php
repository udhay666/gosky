...
<table id="datatable" class="table table-striped table-bordered" style="width:100%">
                    ...
                    <tbody>
                       ...
                       <td><?php echo $j + 1; ?></td>
                        ...
                        <?php if($bus_booking_summary[$j]->gender == 1){?>
                        <td><?php echo "Male" ?></td>
                      <?php }else{?>
                      ...
                      <?php }?>
                        ...
                        <td>
                            <?php
                            $DepartureDateTime = explode('T', $bus_booking_summary[$j]->DepartureTime);
                            // echo $DepartureDateTime[0] ;
                            echo $bus_booking_summary[$j]->DepartureTime;
                            ?>
                        </td>
                        <td>
                            <?php
                            $ArrivalDateTime = explode('T', $bus_booking_summary[$j]->ArrivalTime);
                            // echo $ArrivalDateTime[0];
                             echo $bus_booking_summary[$j]->ArrivalTime;
                            ?>
                        </td>
                        <td>
                             <?php
                         ...
                         <td>
                             <?php
                            echo $bus_booking_summary[$j]->seat_no;
                            ?>
                        </td>
                        <td>
                             <?php
                        ...
                        <td>
                            ...
                            <a target="_blank" href="<?php echo site_url(); ?>bus/bus_eticket/<?php echo $bus_booking_summary[$j]->uniqueRefNo; ?>/<?php  if(!empty($RefIDs)) { echo implode('/',$RefIDs); } else { echo ''; }   ; ?>"><i class="mdi mdi-ticket"></i>E-Ticket</a>
                        </td>
                       </tr>
                       <?php } ?>
                       <?php } ?>
