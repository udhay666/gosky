...
<section class="section-padding inner-page">
  <div class="container">
    ...
    <form name="booking" method="POST" action="<?php echo site_url(); ?>hotels/confirm_reservation?callBackId=<?php echo base64_encode($roomDetails->api); ?>&hotelCode=<?php echo $roomDetails->hotel_code; ?>&searchId=<?php echo $search_id; ?>&sessionId=<?php echo $roomDetails->session_id; ?>" data-parsley-validate >
          ...
          <div class="itinerary-container box-shadow mb-3">
            ...
            <?php for ($a = 0; $a < $adults[$i]; $a++) { ?>
              ...
              <div class="col-sm-2">
                ...
                <?php if(!empty($IsPANMandatory)){?>
                 <div class="col-sm-4">
                  <label>Pan number</label>
                  <input type="text" name="Pan_no[]" value="" id="txtPANCard" class="form-control" required>
                  <span id="lblPANCard" class="error">Invalid PAN Number</span>
                </div> <?php }?>

                <?php if(!empty($IsPassportMandatory)){?>
                 <div class="col-sm-4">
                  <label>Passport number</label>
                  <input type="text" name="Pass_no[]" value="" class="form-control" required>
