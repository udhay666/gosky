      ...
      <div class="row no-gutters mt-4">
         <div class="col-md-8">
            <div class="hotel-details">
               <h3><?php echo $hotelDetails->HotelName.', '.$cityName;  ?> <span class="star star<?php echo $hotelDetails->StarRating  ?>"></span></h3>
            ...
            <div class="row2 ajax-tab-content ajax-content" style="display: none;">
               ...
               <div class="mapdiv" style="display: none;">
                  <iframe src = "https://maps.google.com/maps?q=<?php  echo $hotelDetails->lat;?>,<?php  echo $hotelDetails->long;?>&hl=es;z=14&amp;output=embed" width="100%" height="180" frameborder="0" style="border:0" allowfullscreen></iframe>
               </div>
            </div>
         </div>
         <div class="col-md-4">
            ...
            <div class="price-details">
               <h2 class="price-tag">
               <small>from </small>
               <i class="mdi mdi-currency-inr"></i><span><?php echo number_format($hotel_temp_detail->total_cost); ?></span>
                  ...
                  <div class="col-lg-8 col-md-8">
                     ...
                     <div id="slider" class="flexslider">
                        <ul class="slides">
                           ...
                           <li>
                              <img src="<?php echo $img ?>" alt="<?php echo $hotelDetails->HotelName ?>" height="320" style="height: 320px">
                           </li>
                           <?php } ?>
                        </ul>
                     </div>
                     <div id="carousel" class="flexslider">
                        <ul class="slides">
                           <?php foreach($hotelDetails->images as $img) { ?>
                           <li>
                              <img src="<?php echo $img ?>" alt="<?php echo $hotelDetails->HotelName ?>" height="90" style="height: 90px">
                           </li>
                           <?php } ?>
                        </ul>
                     </div>
                  ...
                  <div class="col-lg-4 col-md-4">
                     ...
                     <div class="row2">
                        ...
                        <ul class="htl-amenities2">
                          <?php $f=0; foreach($hotelDetails->facilities as $fac) { ?>
                            <?php if($f < 8){ ?>
