         ...
         <div class="col-lg-5 col-md-5 mx-auto">
            <div class="itinerary-container box-shadow">
               ...
               <div class="white-container">
                  <form class="form-signin" action="<?php echo site_url() ?>corporate/corporate_login" method="post" data-parsley-validate>
                  ...
                  <div class="modal-footer">
                     ...
                     <div>
                        <a href="<?php echo site_url() ?>corporate/corporate_register" class="btn">SIGN UP</a>
                     </div>
                  </div>
               </div>
            </div>
