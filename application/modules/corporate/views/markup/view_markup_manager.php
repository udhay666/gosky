      ...
      <div class="row">
         <div class="col-lg-12 col-md-12 mx-auto">
            <div class="itinerary-container box-shadow">
               <div class="searchHdr2">Add/Update Markup</div>
               <div class="white-container">
                  <form class="form-horizontal" action="<?php echo site_url(); ?>corporate/add_markup" method="post"  data-parsley-validate>
                     <div class="row">
                        <div class="col-md-3">Corporate Number:</div>
                        <div class="col-md-4">
