...
<section class='my-4'>
  <div class="container">
    ...
    <div class="row">
      <div class="col-sm-12">
        <div id="printArea" class="white-container mb-4">
          <style type="text/css">
          ...
          <?php 
          $websitename='Sarvtoday';
          $companyname='Sarvtoday';
          ?>
          <table class="vouchertable headone" cellpadding="0" cellspacing="0" style="width: 100%">
            <tbody>
              <tr>
                <td><img src="<?php echo base_url(); ?>assets2/images/sarv_logo4.png" width="" alt=""></td>
          ...
          <table class="vouchertable" cellpadding="0" cellspacing="0" style="width: 100%;border: 1px solid #ddd;border-collapse:collapse;border-bottom: 0;">
            ...
            <tbody>
               <?php echo"<pre>";print_r($passenger_info);exit; for ($k = 0; $k < count($passenger_info); $k++) { ?>
              <tr>
                  ...
                  <table class="bordertable" cellpadding="0" cellspacing="0" style="width: 100%;border-collapse:collapse;">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><p><b><?php echo $booking_info->updated_datetime; ?></b></p></td>
          ...
          <table class="vouchertable" cellpadding="0" cellspacing="0" style="width: 50%;border-right: 1px solid #ddd;">
            ...
            <tbody>
              ...
              <? }?>
               <?php if ($booking_info->Promotional_Discount !=''){?>
                 <tr>
                  <td>Discount</td>
                  <td><p>INR</p></td>
                  <td><p><?php echo $booking_info->Promotional_Discount?></p>
                  </td>
                </tr>
              <? }?>
              <tr>
                ...
                <td><p>INR</p></td>
                <td style="text-align: right;"><p><?php
                  $tax = $booking_info->Tax_Amount + $booking_info->Admin_Markup + $booking_info->Agent_Markup ;
                  if(isset($booking_info_r->Tax_Amount)) {
                    $tax_r = $booking_info_r->Tax_Amount + $booking_info_r->Admin_Markup + $booking_info_r->Agent_Markup;
                  } else { 
                      $tax_r = 0;
                  }
               ...
               <tr>
                ...
                <td><p>INR</p></td>
                <td style="text-align: right;"><?php echo $booking_info->Payment_Charge?></td>
              </tr>
              <tr>
                ...
                <td style="text-align: right;"><p style="font-size: 16px;"><b> <?php
                       $Discount = $booking_info->Promotional_Discount;
          ...
          <!--  <table class="vouchertable" cellpadding="0" cellspacing="0" style="width: 50%;border-right: 1px solid #ddd;">
            <thead>
              <tr>
                <th style="background: #d1d2ff;text-align: left;" colspan="3"><p style="font-size: 16px;color: #0c0e69;">Flight Inclusions</p></th>
              </tr>
            </thead>
            <tbody>
              <tr>
                ...
                <tr>
                  ...
                  <td><?php echo $passenger_info[$k]->baggage?></td>
                  <td>0Kg</td>
                  <td>0Kg</td>
                <?php }?>
                </tr>
                <tr>
                  ...
                  <td><?php echo $booking_info->baggage_weight?>KG</td>
                  <td>0Kg</td>
                  <td>0Kg</td>
                </tr>
            </tbody>
