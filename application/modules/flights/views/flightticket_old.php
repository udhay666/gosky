    ...
    <div class="row">
      <div class="col-sm-12">
        <div id="printArea" class="white-container mb-4">
          ...
          <?php 
          $websitename='BizzMirthHolidays';
          $companyname='BizzMirthHolidays';
          ?>
          <table class="vouchertable headone" cellpadding="0" cellspacing="0" style="width: 100%">
            <tbody>
              <tr>
                <td><img src="<?php echo base_url(); ?>images/logo.png" width="" alt=""></td>
              ...
              <tr>
                ...
                <td style="text-align: right;"><p style="font-size: 16px;"><b> <?php
                        ...
                        if(isset($booking_info_r->TotalFare)) {
                          echo number_format($booking_info->TotalFare + $booking_info_r->TotalFare);
                      } else {
                          echo number_format($booking_info->TotalFare);
                      }
