                        ...
                        <div class="col-lg-6 col-md-5">
                            <div class="form-group-wrap">
                                <div class="input-wrap form-group">
                                    <i class="material-icons">&#xE905;</i>
                                    <input type="text" name="fromCity" value="" id="fromCity" placeholder="Flying from" class="autocomplete-airports" tabindex="1" required>
                                ...
                                <div class="input-wrap form-group">
                                    <i class="material-icons">&#xE904;</i>
                                    <input type="text" name="toCity" value="" id="toCity" tabindex="2" placeholder="Flying to" class="autocomplete-airports" required>  
                                    <!--                            <label class="nearby-check-wrap checkbox">
                                                                    <input type="checkbox" name=""><ins></ins>
                                                                    <span>Nearby Airports</span>
                                                                </label>                              -->
    ...
    <div class="panel-body">        
        <div class="btn-group stop-end d-flex" >
            ...
            <label class="btn btn-default active">
                <input type="checkbox" class="Stop" value="0" checked> Direct
            </label>
</div>

        <div class="form-group">
            <label class="btn btn-default">
                <input type="checkbox" class="Stop" value="1" checked> 1  Stop
            </label>
</div>
...
<article class="panel panel-default">
    ...
    <div class="panel-body">
        <ul class="depature-list">
            <li class="active">
                <label><input class="DepartTime" type="checkbox" value="0-6" checked />
                <i class="fa fa-sunset"></i><span>Before<br> 6 AM</span></label></li>
            <li><label><input class="DepartTime" type="checkbox" value="6-12" checked />
            <i class="fa fa-sun-cloud"></i><span>6 AM - <br> 12 PM</span></label></li>
            <li><label><input class="DepartTime" type="checkbox" value="12-18" checked />
            <i class="fa fa-sun-haze"></i><span>12 PM -<br> 6 PM</span></label></li>
            <li><label><input class="DepartTime" type="checkbox" value="18-0" checked />
...
<article class="panel panel-default">
    ...
    <ul class="depature-list">
            ...
            <li class="active">
                <label><input class="ArrivTime" type="checkbox" value="0-6" checked />
                <i class="fa fa-sunset"></i><span>Before<br> 6 AM</span></label></li>
            <li><label><input class="ArrivTime" type="checkbox" value="6-12" checked />
            <i class="fa fa-sun-cloud"></i><span>6 AM - <br> 12 PM</span></label></li>
            <li><label><input class="ArrivTime" type="checkbox" value="12-18" checked />
            <i class="fa fa-sun-haze"></i><span>12 PM -<br> 6 PM</span></label></li>
            <li><label><input class="ArrivTime" type="checkbox" value="18-0" checked />
            <i class="fa fa-moon"></i><span>After<br> 6 PM</span></label></li>
                    ...
                    <div class="col-md-4 mob-display-none">
                        <!-- <div class="pull-right select-filter-wrap"> -->
                            ...
                            <!--<select id="sort-box" class="selectpicker show-tick" data-style="btn-filter" disabled>-->
                             <!-- <select id="sort-box" class="selectpicker show-tick" data-style="btn-filter">
...
<!-- <script src="https://asfartrip.com/public/assets/js/flight-listing.js" ></script> -->
...
<div class="find-hotel-popup hidden-xs hidden-sm hidden-md alert-dismiss">
    ...
    <div class="content">
        ...
        <div class="text-wrap pull-left">
            <a href="/en/hotel/list?dest_code=BOM&country_code=IN&dest_name=Mumbai&room_count=1&adult_count=2&child_count=0&adults1=2&childs1=0&city=Mumbai&check_in=19-01-2022&check_out=20-01-2022&nights=1&SSID=ve82ds8d9irdjp1vmpmsa0os0ca8lv3p" target="_blank">
                <div class="subtitle text-dots" style=""> Mumbai Hotels</div>
                <span>19 Jan, 2022 <i class="fa fa-arrow-circle-o-down" aria-hidden="true"></i></span> <br>
...
<script>
  $('.stop-end .form-group label').click(function() {
  $('.stop-end .form-group label.active').removeClass('active');
