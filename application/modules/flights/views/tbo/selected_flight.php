...
<?php if (!empty($result)) { ?>
    ...
    <div class="FlightInfoBox" style="box-shadow: none;">
        ...
        <div class="fd_img_rp_fx">
            <span class="img_fd_desc"><img src="<?php echo base_url() . 'public/AirlineLogo/' . $operating_airlinecode[0]; ?>.gif" alt="flight-logo" class="icon_img_fd">
                <div class="stcy_desc_fx">
                    <span><?php echo $deptime[1]; ?></span><span class="st_icon"><i class="fa fa-arrow-right"></i></span><span><?php echo $arrtime[1]; ?></span>
                </div>
            </span>
            <span class="fd_rupee fd_price">
                 ₹ <?php echo number_format($total_amount); ?></span>
        </div>


        <!-- <div class="fd_img_fx">
            <img src="<?php echo base_url() . 'public/AirlineLogo/' . $operating_airlinecode[0]; ?>.gif" alt="flight logo">
            <p><?php echo $operating_airlinename[0]; ?></p>
        </div>
        <span class="fd_clr"><?php echo $deptime[1]; ?></span>
        <span class="fd_clr"><?php echo $arrtime[1]; ?></span>
        <div class="fd_time_desc">
            <span class="timer_fx"><i class="material-icons"></i>
