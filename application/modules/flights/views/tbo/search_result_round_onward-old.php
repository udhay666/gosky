...
<!--2nd Content-->
    <section class="flight-elem-parent searchflight_box1" data-price="<?php echo round($total_amount); ?>">
                ...
                <div class="row no-gutter">
                        ...
                        <div class="row row-trip no-gutter">
                            ...
                            <aside class="col-md-7 col-sm-6">
                                <div class="info-stops"> 
                                    <p class="place-wrap"><strong class="city" data-toggle="tooltip" title="" data-original-title="<?php echo $operating_cityname_o[$j]; ?>"><?php echo $operating_cityname_o[$j]; ?> </strong> <span class="code " data-toggle="tooltip" title="" data-original-title="">(<?php echo $operating_airportname_o[$j];?>)</span>
                                        <br><?php 
                                        $dep = explode('T', $operating_deptime[$j]); $dep[1] = substr($dep[1], 0, -3); echo date('dS M',strtotime($dep[0]));?> <strong><?php //echo date('H:i',strtotime($deptime[1]));
                                    ...
                                    <br> <strong>
                                    <?php
                                    $arr = explode('T', $operating_arritime[$j]); $arr[1] = substr($arr[1], 0, -3);
                                    echo $arr[1];
                                    ?></strong> <?php echo date('dS M',strtotime($arr[0]));?> 
                            ...
                            <aside class="col-md-3  col-sm-4">
                                <div class="info-duration">
                                    ...
                                    <span class="time"><?php echo $this->Tbo_Model->journeyDuration(str_replace("T", " ", $operating_deptime[$j]),str_replace("T", " ", $operating_arritime[$j])); ?></span>
                    ...
                    <aside class="col-md-3 col-sm-12">
                        <div class="info-buy">
                            ...
                            <span class="price-new"><span class="currency"><?php echo $currency; ?></span> <?php echo number_format($total_amount); ?></span></p>
                            <form name="<?php echo "flight_segmentform_".$i.$operating_airlinecode[0].round($total_amount); ?>" id="<?php echo "flight_segmentform_".$i.$operating_airlinecode[0].round($total_amount); ?>">
                                ...
                                <input type="hidden" name="temp_price" value="<?php echo round($total_amount); ?>">
                                <p>
                ...
                <div class="tab-content">
                                ...
                                <div class="row row-trip no-gutter">
                                    ...
                                    <aside class="col-sm-7 col-xs-12">
                                        <div class="info-flight-way"><?php $deptime1 = explode(' ',$operating_deptime[0]); $deptime1=substr($deptime1[1], 0, -3); ?>
                                            ...
                                            <br><?php echo date('dS M',strtotime($operating_deptime[0]));?> <strong>
                                            <?php
                                            ...
                                            ?>
                                                ...
                                                <br><?php echo $this->Tbo_Model->airportname($operating_airportname_o[0]); ?> <br>Terminal: <?php echo $operating_terminal_o[0]; ?></p>
                                            <p class="way-wrap">
                                            <span class="txt-time"><?php echo $this->Tbo_Model->journeyDuration(str_replace("T", " ", $operating_deptime[0]),str_replace("T", " ", $operating_arritime[0])); ?></span>
                                                <span class="travel-stops">
                                                    <span class="start"></span>
                                                    <span class="end"></span>
                                                </span>
                                        ...
                                        echo $arr[1];
                                        ?>
                                            </strong> <?php echo date('dS M',strtotime($operating_arritime[0]));?> <span data-toggle="tooltip" title="" class="badge" data-original-title="Arrival next day">+1</span>
                                                <br><?php echo $this->Tbo_Model->airportname($operating_airportname_d[0]); ?> <br>Terminal: <?php echo $operating_terminal_d[0]; ?></p>
                                        </div>
                                    </aside> <!-- col // -->
                                ...
                                <div class="row row-trip no-gutter">
                                    ...
                                    <aside class="col-sm-7 col-xs-12">
                                        <div class="info-flight-way"><?php $deptime2 = explode(' ',$operating_deptime[1]); $deptime2=substr($deptime2[1], 0, -3); ?>
                                            ...
                                            <br><?php echo date('dS M',strtotime($operating_deptime[1]));?> <strong>
                                            <?php
                                            $dep = explode('T', $operating_deptime[1]);
                                            $dep[1] = substr($dep[1], 0, -3);
                                            echo $dep[1];
                                            ?>
                                            </strong>
                                                <br><?php echo $this->Tbo_Model->airportname($operating_airportname_o[1]); ?> <br>Terminal: <?php echo $operating_terminal_o[1]; ?></p>
                                            <p class="way-wrap">
                                                <span class="txt-time"><?php echo $this->Tbo_Model->journeyDuration(str_replace("T", " ", $operating_deptime[1]),str_replace("T", " ", $operating_arritime[1])); ?></span>
                                                <span class="travel-stops">
                                                    <span class="start"></span>
                                                    <span class="end"></span>
                                                </span>
                                            ...
                                            <p class="place-wrap-to">(<?php echo $operating_airportname_d[1];?>) <strong><?php echo $operating_cityname_d[1]; ?></strong>
                                                <br><strong>
                                                <?php
                                        $arr = explode('T', $operating_arritime[1]);
                                        $arr[1] = substr($arr[1], 0, -3);
                                        echo $arr[1];
                                        ?>
                                            </strong> <?php echo date('dS M',strtotime($operating_arritime[1]));?> <span data-toggle="tooltip" title="" class="badge" data-original-title="Arrival next day">+1</span>
                                                <br><?php echo $this->Tbo_Model->airportname($operating_airportname_d[1]); ?> <br>Terminal: <?php echo $operating_terminal_d[1]; ?></p>
                                        </div>
                                    </aside> <!-- col // -->
                                    <aside class="col-sm-3 col-xs-12 hidden-xs"> 
                                        <ul class="list-default">
                    ...
                    <section class="tab-pane fade" id="fare_menu-<?php echo $i.$operating_airlinecode[0].round($total_amount); ?>">
                        <article class="ticket-detail panel-body">
                            ...
                            <table class="table-round">	
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <p class="key-val"> <span>Total (incl. VAT):</span> <var><?php echo $currency.' '.round($total_amount); ?></var></p>
                            ...
                            <p class="alert alert-info">Note: travelfreebuy.com applies VAT as per the INDIAN law. For more info, please view our <a href="<?php echo base_url(); ?>cms/faq" target="_blank">FAQs</a></p>
                        </article> <!-- ticket-detail// -->
                    </section> <!--  tab-pane //  -->
                        ...
                        <article class="ticket-detail">
                            ...
                            <table class="table table-baggage">
                                    <tbody><tr>
                                        ...
                                        <td width="400"><p><strong class="text-primary">Carry-on:</strong> <?php echo "7 KG"; ?>/person                                </p>
                                            <p><strong class="text-primary">Check-in:</strong><span class="outward_baggage_06E2137295">
                                                    <?php if(!empty($baggageinformation2[0])){echo $baggageinformation2[0];}else{
                            ...
                            <table class="table-baggage">
                                    ...
                                    <td class="info-airline"> <img src="<?php echo base_url() . 'public/AirlineLogo/' .$operating_airlinecode[1]; ?>.gif" alt="flight logo"> <br><small><?php echo $operating_airlinename[1]; ?></small></td>
                                        <td width="400"><p><strong class="text-primary">Carry-on:</strong> <?php echo "7 KG"; ?>/person                                </p>
                                            ...
                                            <?php if(!empty($baggageinformation2[1])){echo $baggageinformation2[1];}else{
                                                    echo "Sorry! Baggage information will be available at the next step";   } ?>                            
                                                </span>                                   
                            ...
                            <?php if(empty($baggageinformation2[1])){ ?>
