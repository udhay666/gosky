...
<?php if (!empty($result2)) { $result = $result2;//echo"<pre>";print_r($result1);exit;?>
...
<section class="flight-elem-parent searchflight_box1 selectItem2" data-price="<?php echo round($total_amount); ?>">
<label for="rRadio<?=$i?>">        
            ...
            <article id="<?php echo round($total_amount); ?>" class="item-flight_r ">
                <p class="ticket-highlight-info hide" id="z-<?php echo round($total_amount); ?>"><i class="fa fa-check"></i> &nbsp; THIS IS THE CHEAPEST FLIGHT FOR THESE DATES!</p>
                    ...
                    <main class="main-onward">
                            ...
                            <aside class="col-md-3 col-sm-4 rd_price">
