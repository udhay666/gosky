  ...
  <?php $this->load->view('booking_header'); ?>
    ...
    <div class="row">
      <div class="col-lg-12 col-md-12 mx-auto">
        <form action="<?php echo site_url();?>b2c/deposit_request" method="post" enctype="multipart/form-data" class="form-horizontal" data-parsley-validate>
            ...
            <div class="white-container">
              <div class="row">
                <div class="col-md-3">
                  ...
                  <input type="text" class="form-control form-group " placeholder="<?php echo $user_info->user_no; ?>" readonly disabled="">
                </div>
                <div class="col-md-3">
                  <label>Available</label>
                  <input type="text" class="form-control form-group " placeholder="<?php if(!empty($user_deposit_details)) echo $user_deposit_details[0]->available_balance; else echo '0.00'; ?>" disabled="" readonly>
                </div>
                <div class="col-md-3">
...
//echo '<pre>';print_r($user_deposit_details);exit;
                  ...
                  <tr>
                    ...
                    <td class="text-danger"><?php echo $user_deposit_details[$i]->status ; ?></td>
                  </tr>
                  <?php } ?>
                  <?php } ?>
                </tbody>
