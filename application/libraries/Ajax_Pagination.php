...
class Ajax_Pagination{
   ...
   var $show_count      = true;
	...
	function getAJAXlink( $count, $text) {
		...
		return "<a href=\"#\"
		         " . $this->anchor_class . "
					onclick=\"$('.ajaxloading').show();$.post('". $this->base_url . $count ."', ". $this->additional_param .", function(data){
					$('.ajaxloading').hide();$('". $this->div . "').html(data.hotels_search_result);$('#pagination_up').html(data.paging);$('#pagination_down').html(data.paging);" . $this->js_rebind ."; }, 'json'); return false;\">"
				. $text .'</a>';
	}
