...
class Googlemapsnew {
	...
	var $apiKey						= 'AIzaSyADPfKkRh8XYqiV5gPIzPW1CdXAbR7l9gE'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
