										...
										<div class="tab-pane active" id="step-1">
											<div class="row border_row">
												...
												<div class="form-group col-md-4">
													...
													<input name="excursion_category" id="excursion_category" value="<?php echo $excursion_info->excursion_category ?>" type="text" class="form-control" required="required">
												</div>
												<div class="form-group col-md-4">
													<label class="strong" for="excursion_promo">Promotion:</label>
													<input name="excursion_promo" id="excursion_promo" value="<?php echo $excursion_info->excursion_promo ?>" type="text" class="form-control">
												</div>
											</div>
											<div class="row border_row">
												<div class="form-group col-md-12">
													<label class="strong" for="excursion_desc">Excursion Description:</label>
													<textarea name="excursion_desc" class="form-control" rows="3" id="excursion_desc"><?php echo $excursion_info->excursion_desc ?></textarea>
												</div>
											</div>
											<div class="row border_row">
												<div class="form-group col-md-4">
													<label class="strong" for="no_of_days">No of Days:</label>
													<input name="no_of_days" id="no_of_days" value="<?php echo $excursion_info->no_of_days ?>" type="text" class="form-control" data-parsley-trigger="keyup" data-parsley-type="digits"  required="required">
												</div>
												<div class="form-group col-md-4">
													<label class="strong" for="country">Country:</label>
													<input name="country" id="country" value="<?php echo $excursion_info->country ?>" type="text" class="form-control" required="required">
												</div>
											</div>
											<div class="row border_row min_height200">
												<div class="col-md-12">
													...
													<input type="hidden" name="controller" value="sup_excursion_images_id">
