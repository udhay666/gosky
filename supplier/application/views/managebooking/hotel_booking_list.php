        ...
        <div class="pageheader">
          ...
          <div class="page-bar  br-5">
            <ul class="page-breadcrumb">
              ...
              <li><a class="active" href="<?php echo site_url() ?>managebooking/hotel_booking">Manage Hotel Booking</a></li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-12">
        <section class="boxs">
          <div class="boxs-header dvd dvd-btm">
            <h1 class="custom-font"><strong>Manage Hotel Booking</strong> </h1>
            <ul class="controls">
           ...
           <table class="table table-custom dt-responsive" cellspacing="0" width="100%" id="table1">
            <thead>
              <tr>
                ...
                <th>Children</th>
                <th>Total Cost</th>
                <th class="none">Extra Bed(Adults)</th>
                <th class="none">Extra Bed(Children)</th>
            ...
            <tbody>
              ...
              <tr>
                <?php //echo '<pre>';print_r($hotel_booking_list); ?>
                <td><?php echo $i + 1; ?></td>
                ...
                <td><?php echo $hotel_booking_list[$i]->total_amount; ?></td>
                  <td class="none"><?php echo $hotel_booking_list[$i]->adult_extrabed; ?></td>
                <td class="none"><?php echo $hotel_booking_list[$i]->child_extrabed; ?></td>
                ...
                <td class="none"><?php echo $hotel_booking_list[$i]->paid_status; ?></td>
                <td class="none">              
