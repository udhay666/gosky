          ...
          <div class="pagecontent">
            <div class="page page-full page-calendar">
             ...
             <div class="tcol"> 
              ...
              <h2 class="custom-font text-default m-0"><strong><small>Hotel <?php echo $hotel_detail->hotel_name; ?><br/><?php echo $rooms_detail->room_name.' ('.$this->glb_hotel_room_type->get_single($rooms_detail->hotel_room_type)->room_type.')'; ?> <br/><span style="color: red;font-weight: 800;" >Allotment Details</small></strong></h2>
            </div>
   ...
   $('.changecal').on( "click", function(){
    ...
    function loadroomrates1()
       ...
       $.ajax({       
        ...
        data: 'room_id='+$room_id+'&hotel_code='+$hotel_code+'&contract_id='+$contract_id+'&startdate='+$startdate+'&enddate='+$enddate,
        dataType: 'json',
        type: 'POST',
        beforeSend: function(){
