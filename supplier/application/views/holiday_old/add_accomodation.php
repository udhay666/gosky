    ...
    <div class="row">
      <div class="col-md-12">
        <div class="pageheader">
          <h2>Add Accommodation <span></span></h2>
          <div class="page-bar  br-5">
            <ul class="page-breadcrumb">
              <li><a href="<?php echo site_url() ?>"><i class="fa fa-home"></i> Dashboard</a></li>
              <li><a href="#">Holidays</a></li>
              <li><a class="active" href="#">Add Accommodation</a></li>
            </ul>
          </div>
        </div>
      </div>
                ...
                <div class="row border_row min_height200">
                  <div class="col-md-12">
                    ...
                    <span class="btn btn-success fileinput-button">
                        ...
                        <span>Add image...</span>
                        <input type="file" accept="image/*" class="form-control imageupload" name="uploadfile[]" /><br/>
                    </span>
                    <input type="hidden" name="unique_id" value="id">
                    <input type="hidden" name="table_name" value="holiday_accomodation">
                    <input type="hidden" name="column_name" value="thumb_img">
                    <input type="hidden" name="img_type" value="thumbnail">
                    <input type="hidden" name="upload_type" value="custom_update">
                    <!-- <input name="submit" value="Upload" class="btn btn-primary upload_now" /> -->

                    <div class="row2 preview-image">
                      <?php if(!empty($edit_accomodation->thumb_img)){ ?>
                      <div class="row2 remove_in_colne" style="margin-top: 15px">
                        <div class="priv_div" style="position:relative;display:inline-block">
                          <img src="<?php echo base_url().$edit_accomodation->thumb_img ?>" img_url="<?php echo $edit_accomodation->thumb_img ?>" title="" class="thumbimage" />
                        </div>
                      </div>
                      <?php } ?>
                    </div>
                ...
                <table class="table table-custom" id="advanced-usage">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo $accomodation_info[$i]->hotel_city; ?></td>
                      <td>
                      ...
                      <td>
                        <?php if($accomodation_info[$i]->status == 0) { ?>
                        <!-- <a class="btn btn-success btn-rounded btn-sm btn-ef btn-ef-5 btn-ef-5a" href="<?php echo site_url(); ?>holiday/set_theme_status/<?php echo $accomodation_info[$i]->id;  ?>/1" onclick="return confirm('Do you really want to Active this Theme. ?')"><i class="fa fa-check"></i> <span>Active</span></a>&nbsp;&nbsp;&nbsp;|&nbsp; -->
                        <?php } else { ?>
                        <!-- <a class="btn btn-danger btn-rounded btn-sm btn-ef btn-ef-5 btn-ef-5a" href="<?php echo site_url(); ?>holiday/set_theme_status/<?php echo $accomodation_info[$i]->id;  ?>/0" onclick="return confirm('Do you really want to InActive this Theme. ?')"><i class="fa fa-times"></i> <span>Inactive</span></a>&nbsp;|&nbsp; -->
                        <?php } ?>
