    ...
    <div class="pagecontent">
      <div id="rootwizard" class="form_wizard wizard_horizontal tab-wizard">
        <ul class="wizard_steps nav nav-pills">
          ...
          <li class="active"><a href="<?php echo site_url() ?>holiday/edit_step7?id=<?php echo $package_id ?>"><span class="step_no wizard-step">7</span><span class="step_descr">Step 7<br><small>Activities(Optional)</small></span></a></li>
        ...
        <div class="tab-content">
          <form action="<?php echo site_url() ?>holiday/update_all" method="post" class="step_form step7" steps="7" name="step7" method="POST" enctype="multipart/form-data" role="form" novalidate>
                    ...
                    <div class="boxs-body">
                      <div class="row border_row">
                        <div class="form-group col-sm-4">
                          ...
                          <input type="text" name="activity_name[]" value="<?php echo $holiday_activity[$i]->activity_name ?>" class="form-control">
                        </div>
                      </div>
                      <div class="row border_row">
                        <div class="form-group col-sm-12">
                          <label class="strong">Description</label>
                          <textarea name="activity_description[]" id="activity_description" class="form-control ckeditor" rows="3" cols="100"><?php echo $holiday_activity[$i]->activity_description ?></textarea>
                        </div>
                      </div>
                      <div class="row border_row">
                        <div class="form-group col-sm-4">
                          <label class="strong">Adult Cost</label>
                          <input type="text" name="activity_adult_cost[]" value="<?php echo $holiday_activity[$i]->activity_adult_cost ?>" class="form-control">
                        </div>
                        <div class="form-group col-sm-4">
                          <label class="strong">Child Cost(Below 12 years)</label>
                          <input type="text" name="activity_child_cost[]" value="<?php echo $holiday_activity[$i]->activity_child_cost ?>" class="form-control">
                        </div>
                        <div class="form-group col-sm-4">
                          <label class="strong">Family Cost(2 Adults + 2 Children)</label>
                          <input type="text" name="activity_family_cost[]" value="<?php echo $holiday_activity[$i]->activity_family_cost ?>" class="form-control">
                        </div>
                      </div>
...
$('.upload_now').on('click', function(){
    ...
    data.append('table_name', 'holiday_activity_images');
