        ...
        <div class="pageheader">
          ...
          <div class="page-bar br-5">
            <div class="form-group">
              <a href="<?php echo site_url() ?>holiday/quick_add" class="btn btn-success" type="button"><i class="fa fa-edit m-right-xs"></i> Add Your Property</a>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="boxs-body">
            ...
            <table class="table table-custom" id="advanced-usage">
              ...
              <tbody>
                ...
                <tr>
                  <td><?php echo $i+1; ?></td>
                  <td><?php echo $packages[$i]->holiday_name ?></td>
                  <td><?php echo $packages[$i]->holiday_code ?></td>
                  <td><?php echo $packages[$i]->holiday_type ?></td>
                  ...
                  <td><a  target="_blank" class="btn btn-primary btn-xs" href="<?php echo str_replace('admin/', '', site_url()) ?>holiday/preview_holiday/<?php echo $packages[$i]->id; ?>"><i class="fa fa-eye"></i> Preview</a></td>
                </tr>
                <?php } ?>
                <?php } ?>
              </tbody>
