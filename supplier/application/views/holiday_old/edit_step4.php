            ...
            <div class="tab-pane active" id="step-4">
              ...
              <div class="row border_row">
                <div class="form-group col-sm-12">
                  ...
                  <textarea name="includes" class="form-control ckeditor" rows="3" cols="100"><?php echo $package_info->includes ?></textarea>
                </div>
              </div>
              <div class="row border_row">
                <div class="form-group col-sm-12">
                  <label class="strong">Excludes</label>
                  <textarea name="excludes" class="form-control ckeditor" rows="3" cols="100"><?php echo $package_info->excludes ?></textarea>
                </div>
              </div>
            </div>
