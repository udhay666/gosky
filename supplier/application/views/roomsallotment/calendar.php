      ...
      <div class="col-md-12">
        <section class="boxs">
          <div class="boxs-header dvd dvd-btm">
            <h1 class="custom-font"><strong>Room <span style="color: red;font-weight: 800;" >Allotment</strong></h1>
            <ul class="controls">
           ...
           <div class="boxs-body">
               ...
               <div class="form-group col-md-3">
                 ...
                 <select class="form-control select2" name="room_allotment_type" id="room_allotment_type">
          ...
          <div class="pagecontent">
            <div class="page page-full page-calendar">
             ...
             <div class="tcol"> 
              ...
              <h2 class="custom-font text-default m-0"><strong><small>Hotel <?php echo $hotel_detail->hotel_name; ?><br/>Contract Number : <?php echo $contract_detail->contract_number; ?> <br/><span style="color: red;font-weight: 800;" >Allotment Details</small></strong></h2>
            </div>
  ...
  loadroomrates();
   ...
   $('.changecal').on( "click", function(){
    ...
    function loadroomrates1()
       ...
       $.ajax({       
        url: siteUrl + 'roomsallotment/get_room_allotment_monthlist',
        data: 'hotel_id='+$hotel_id+'&hotel_code='+$hotel_code+'&contract_id='+$contract_id+'&startdate='+$startdate+'&enddate='+$enddate,
        dataType: 'json',
        type: 'POST',
        beforeSend: function(){
    ...
    function loadroomrates($t='')
       ...
       $.ajax({       
        ...
        data: 'hotel_id='+$hotel_id+'&hotel_code='+$hotel_code+'&contract_id='+$contract_id+'&month='+$getmonth+'&year='+$getyear,
        dataType: 'json',
        type: 'POST', 
        beforeSend: function(){
           $('#loadroomratesajax').modal('show'); 
...
$('#show_calender').on('click', function(){
 ...
 form.parsley().validate();
      ...
      {
        $.ajax({
                    url: siteUrl + 'roomsallotment/get_room_allotment_monthcalender',
                    data: form.serialize(),
                    dataType: 'json',
                    type: 'POST',
                    beforeSend: function(){
