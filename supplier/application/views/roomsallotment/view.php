          ...
          <div class="page-bar br-5">
            <div class="form-group">
              <ul class="page-breadcrumb">
                ...
                <li><a class="active" href="<?php echo site_url(); ?>roomsallotment/view_room_allotment">View Room Allotment</a></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-12">
        <section class="boxs">
          <div class="boxs-header dvd dvd-btm">
            <h1 class="custom-font">View  Room Allotment</h1>
            <ul class="controls">              
          ...
          <div class="boxs-body">  
        <form action="<?php echo site_url();?>roomsallotment/room_allotment_list" method="post">  
