          ...
          <div class="boxs-body">  
            ...
            <div id="loadroomratedetails"> 
             ...
             <!--  <input type="hidden" name="meal_plan" value="<?php echo $meal_planstr; ?>">  -->            
              ...
              <label class="strong" for="contractperiod">Contract Period: <?php echo ' From '.date('d-M-Y',strtotime($contract_list[0]->start_date)).' to '.date('d-M-Y',strtotime($contract_list[0]->end_date)); ?></label>
             </div>
