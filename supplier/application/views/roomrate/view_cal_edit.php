          ...
          <div class="page-bar br-5">
            <div class="form-group">
              <ul class="page-breadcrumb">
                ...
                <li><a class="active" href="<?php echo site_url(); ?>roomrates/edit_rates_room">Edit Room Rates</a></li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <div class="row">
      <div class="col-md-12">
        <section class="boxs">
          ...
          <div class="boxs-body">  
        <form action="<?php echo site_url();?>roomrates/get_hotel_room_rates_def" method="post">            
