                    ...
                    <div class="boxs-body">
                      <div class="row border_row">
                        ...
                        <div class="form-group col-sm-4">
                          ...
                          <select name="attraction_day[]" class="form-control active_day">
                            <?php for($d=1;$d<=$duration;$d++){ ?>
                            <option value="<?php echo $d ?>" <?php if($holiday_attraction[$i]->attraction_day==$d) echo 'selected' ?>>Day <?php echo $d ?></option>
                            <?php } ?>
                          </select>
                        </div>
                      </div>
                      <div class="row border_row">
                        <div class="form-group col-sm-12">
                          ...
                          <textarea name="attraction_description[]" id="attraction_description<?php echo $i+1 ?>" class="form-control ckeditor" rows="3" cols="100"><?php echo $holiday_attraction[$i]->attraction_description ?></textarea>
                        </div>
                      </div>
                      <div class="row border_row">
                        <div class="form-group col-sm-4">
...
for(var i=1;i<cloneCount;i++){
  CKEDITOR.replace('attraction_description'+i, tools);
}
</script>
<script type="text/javascript">
jQuery(function($) {
  $("#attraction_wrapper").each(function() {
    ...
    $(".add-field", $(this)).on('click', function(e){
      ...
      CKEDITOR.replace('attraction_description'+(cloneCount-1), tools);
