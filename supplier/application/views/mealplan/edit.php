        ...
        <div class="pageheader">
          ...
          <div class="page-bar  br-5">
            <ul class="page-breadcrumb">
              ...
              <li><a class="active" href="<?php echo site_url() ?>meal_plan/view_meal_plan_info/<?php echo $id; ?>">Edit Meal Plan</a></li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-12">
        ...
        <form id="basicForm" class="form-horizontal" action="<?php echo site_url() ?>meal_plan/<?php echo $action ?>" enctype="multipart/form-data" method="post">
           <div class="form-group">                     
             ...
             <div class="col-sm-2">
              <input class="form-control" id="focusedInput" type="text" name="meal_plan" value="<?php echo $mealplan->meal_plan;?>" required="">
