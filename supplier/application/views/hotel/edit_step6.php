        ...
        <div class="tab-content">       
           <form class="step_form step6" steps="6" name="step6" role="form">
            ...
            <div class="tab-pane active" id="step-6">
              ...
              <div class="row border_row">
                <div class="form-group col-md-8">
                  <label class="strong" for="">Child Policy : </label>
                  <textarea class="form-control ckeditor" name="child_policy" id="" rows="4"><?php echo $hotel_details[0]->child_policy;?></textarea>
                </div>
              </div>
              <div class="row border_row">
                <div class="form-group col-md-8">
