                  ...
                  <label class="strong">Hotel Facilities : </label>
                    ...
                    <?php
                     ...
                     for($i=0;$i<count($hotel_facilities);$i++){
                      ...
                      ?>
                      <li><label class="checkbox-inline checkbox-custom2 checkbox-custom2-sm"><input type="checkbox" name="hotel_facilities[]" class="flat" value="<?php echo $hotel_facilities[$i]->facility;?>" <?php if(in_array($hotel_facilities[$i]->facility,$facilities)){  echo "checked"; }?>><i></i> <?php echo $hotel_facilities[$i]->facility;?></label></li>
                     <?php } }?>                     
                  </ul>
                </div>
              </div>
   ...
   var form = $('form[name="step3"]'); 
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        if(todo == 1){
          location.href='<?php echo site_url();?>hotel/edit_step4?id='+$ins_id1;
        } else{
