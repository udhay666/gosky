        ...
        <section class="boxs">
          ...
          <table class="table table-custom dt-responsive" cellspacing="0" width="100%" id="table1">
             ...
             <td> 
                 ...
                 <td class="none">
                 <?php echo $propertytypeall[$hotel_details[$i]->hotel_property_type]; ?></td>
                  <td class="none">
                  <?php echo $hotel_details[$i]->hotel_star_rating; ?></td>
                  <td class="none">
                  <?php echo $hotel_details[$i]->email; ?></td>
                  <td class="none">
                  <?php echo $hotel_details[$i]->hotel_city; ?></td>
                   <td class="none">
                   <?php echo $hotel_details[$i]->hotel_country; ?></td>
                </tr>
              <?php } }?>
              </tbody>
            </table>
