            ...
            <form action="<?php echo site_url()?>room/add_room_details" method="post" class="step_form step1" steps="1" name="step1" role="form">
              <div class="row border_row">
                <div class="form-group col-md-4">
                  ...
                  <select name="hotelname" id="hotelname" class="form-control select2" required="required">
                    ...
                    <option value="<?php echo $hotel_details[$i]->supplier_hotel_list_id.'*'.$hotel_details[$i]->hotel_code; ?>"><?php echo $hotel_details[$i]->hotel_name.' ('.$hotel_details[$i]->hotel_code.')';?></option>                 
                    <?php } ?>
                  </select>
                </div>
                <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-10">
                  ...
                  <ul class="check_width check_icon">                   
                    <?php 
                       ...
                       ?>
                      <li><label class="checkbox-inline checkbox-custom2 checkbox-custom2-sm"><input type="checkbox" name="mealplan[]" class="flat mealplan" value="<?php echo $mealplan[$i]->id;?>" checked="checked"><i></i> <?php echo $mealplan[$i]->meal_plan;?></label></li>
                     <?php } } ?> 
                  </ul>
                </div>
              </div> 
              ...
              <!--  <div class="row border_row">
                ...
                <div class="row border_row">  
                 <div class="form-group col-md-3">
                  ...
                  <ul class="check_width check_icon">                  
                    <li>
                    <label class="checkbox-inline checkbox-custom2 checkbox-custom2-sm" style="min-width: 200%;"><input type="checkbox" name="extrabedpermission" id="extrabedpermission" class="flat" value="1" checked="true"><i></i>Allow Extra Beds</label></li>
                  </ul>                 
                </div>         
                  <div class="form-group col-md-2">
              ...
              <div class="row border_row">
                <div class="form-group col-md-6">
                  ...
                  <input name="inclusions" id="inclusions" value="<?php echo set_value('room_name'); ?>" type="text" class="form-control" required="required">
                  <p>Use comma as a seperator(eg ~ TV,AC)</p>
                </div>
                <div class="form-group col-md-6">
                  <label class="strong" for="exclusions">Exclusions : </label>
                  <input name="exclusions" id="exclusions" value="<?php echo set_value('room_name'); ?>" type="text" class="form-control" required="required">
                  <p>Use comma as a seperator(eg ~ TV,AC)</p>
                </div>
              </div>  
                <div class="row border_row">
                <div class="form-group col-md-10">
                  ...
                  <ul class="check_width check_icon">                   
                    <?php 
                       ...
                       ?>
                      <li><label class="checkbox-inline checkbox-custom2 checkbox-custom2-sm"><input type="checkbox" name="room_facilities[]" class="flat" value="<?php echo $room_facilities[$i]->id;?>" checked="checked"><i></i> <?php echo $room_facilities[$i]->facility;?></label></li>
                     <?php } } ?> 
                  </ul>
                </div>
              </div>   
              ...
              <div class="row border_row">
                <div class="form-group col-md-12">
                  ...
                  <textarea name="room_policies" class="form-control" rows="3" required="required" data-parsley-required="true" data-parsley-required-message="This field is required" id="room_policies"><?php echo set_value('room_policies'); ?></textarea>
                </div>
              </div>  
