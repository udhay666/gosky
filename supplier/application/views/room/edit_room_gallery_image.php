  ...
  <div class="page page-forms-wizard">
        ...
        <div class="pageheader">        
          <div class="page-bar  br-5">
            <ul class="page-breadcrumb">
              ...
              <li><a class="active" href="<?php echo site_url() ?>room/edit_room_gallery_image?id=<?php echo $room_id; ?>">Add/Edit Room Image</a></li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-12">
        <section class="boxs">
          <div class="boxs-header dvd dvd-btm">
            <h1 class="custom-font">Add/Room Gallery Image</h1>
            <ul class="controls">            
    ...
    <div class="pagecontent">
      <div id="rootwizard" class="form_wizard wizard_horizontal tab-wizard">
        ...
        <input type="hidden" name="table_name" value="supplier_room_gallery_images">
                  <input type="button" name="submit" value="Upload" class="btn btn-primary upload_now" />
                    <div class="row2" style="margin-top: 15px">
                    <?php foreach($supplier_room_gallery_images as $gal) { ?>
...
$('.upload_now').on('click', function(){
    ...
    data.append('table_name', 'supplier_room_gallery_images');
    ...
    $.ajax({
        ...
        data: data,
        url: '<?php echo site_url(); ?>room/do_upload_room_img',
        dataType : 'json',
        beforeSend: function(){
