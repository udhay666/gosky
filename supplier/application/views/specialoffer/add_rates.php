      ...
      <div class="col-md-12">
        <section class="boxs">
          ...
          <div class="boxs-body">  
            ...
            <div id="loadroomratedetails"> 
             ...
             <div class="form-group col-md-4">
              <label class="strong">Hotel: <?php echo $hotel_name;?></label>         
                </div>
          ...
          <!--    <input type="hidden" name="meal_plan" value="<?php echo $meal_planstr; ?>">        -->      
              ...
              <label class="strong" for="contractno">Contract Period: <?php echo ' From '.date('d-M-Y',strtotime($contract_list[0]->start_date)).' to '.date('d-M-Y',strtotime($contract_list[0]->end_date)); ?></label>
             </div>
              ...
              <label class="strong" for="market">Market: <?php echo $market; ?></label> 
                 ...
                 <div class="form-group col-md-4">
                <label class="strong">Room: <?php echo $room_list[0]->room_name.' ('.$this->glb_hotel_room_type->get_single($room_list[0]->hotel_room_type)->room_type.')';?></label>         
                </div> 
                  <div class="form-group col-md-4">
          ...
          <!--    <div class="row border_row">
               <div class="form-group col-md-4"> 
                ...
                <div class="form-group col-md-4 check_icon">                 
                    <label class="checkbox-inline checkbox-custom2 checkbox-custom2-sm">
                    <input type="radio" class="flat supplement_compulsory"   name="supplement_compulsory" value="Yes">
                    <i></i> Yes
                    </label>               
                </div> 
                 <div class="form-group col-md-4 check_icon">                 
                   <label class="checkbox-inline checkbox-custom2 checkbox-custom2-sm">
                    <input type="radio" class="flat supplement_compulsory"   name="supplement_compulsory" value="No" checked="checked">
                    <i></i> No 
                    </label> 
                  </div>                 
                </div> -->               
                ...
                <label class="strong">Special Offer Type : Discount</label> 
                 ...
                 <div class="form-group col-md-3"> 
                      <label class="strong">Enter Booking Code</label>
                       <input type="text" name="booking_code"  class="form-control"  placeholder="Enter Booking Code" required="required"/>
                  </div>
            ...
            <label class="checkbox-inline checkbox-custom2 checkbox-custom2-sm">
              ...
              <div class="row  border_row">
                ...
                <input type="text" name="min_no_of_stay_day" id="min_no_of_stay_day"  class="form-control Num"  placeholder="Min number of Nights" required="required"/>
               </div>
             
                <div class="form-group col-md-4"> 
                <label class="strong">Max number of Nights</label> 
                
                <input type="text" name="max_no_of_stay_day"  id="max_no_of_stay_day" class="form-control Num"  placeholder="Max number of Nights" required="required"/>
               </div>             
                <div class="form-group col-md-4"> 
              <label class="strong">Enter Discount Percentage(%)</label>              
              <input type="text" name="discount_percentage" id="discount_percentage" class="form-control deciNum"  placeholder="Discount Percentage" required="required"/>
               </div>
             </div>
           <!--    <div class="row  border_row">
                <div class="form-group col-md-3"> 
            ...
            <?php } else if($specialoffer_type[0]->id==3 && $specialoffer_type[0]->type=="Stay Pay"){ ?> 
              ...
              <div class="row border_row">
               ...
               <div class="row  border_row">
                ...
                <input type="text" name="min_no_of_stay_day" id="min_no_of_stay_day" class="form-control Num"  placeholder="Min number of stay days" required="required"/>
               </div>
             
                <div class="form-group col-md-4"> 
                <label class="strong">Max number of stay days</label> 
                
                <input type="text" name="max_no_of_stay_day" id="max_no_of_stay_day" class="form-control Num"  placeholder="Max number of stay days" required="required"/>
               </div>             
                <div class="form-group col-md-4"> 
                <label class="strong">No of free nights</label> 
               
                <input type="text" name="no_of_stay_free_nights" id="no_of_stay_free_nights"  class="form-control Num"  placeholder="No of free nights" required="required"/>
               </div>
             </div>
...
<script type="text/javascript">
  ...
  $.ajax({
     url: site_url+'specialoffer/get_mealplan_details/',
    data: {id:$id},
    dataType: 'json',
    type: 'POST',
    success: function(data) {   
