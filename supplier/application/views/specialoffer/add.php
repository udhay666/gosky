          ...
          <div class="page-bar br-5">
            <div class="form-group">
              <ul class="page-breadcrumb">
                ...
                <li><a class="active" href="<?php echo site_url(); ?>specialoffer/add">Add Special Offer Room Rates</a></li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <div class="row">
      <div class="col-md-12">
        <section class="boxs">
          ...
          <div class="boxs-body">  
        <form action="<?php echo site_url();?>specialoffer/add_room_rates" id="add_room_rates" method="post">  
...
$('#checkexistingrate').on('click', function()
{
     ...
     form.parsley().validate();
      ...
      {
         $.ajax({
                    url: site_url + 'specialoffer/view_existing_rate',
                    data: form.serialize(),
                    dataType: 'json',
                    type: 'POST',
                    beforeSend: function()
