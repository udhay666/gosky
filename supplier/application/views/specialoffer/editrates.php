          ...
          <div class="page-bar br-5">
            <div class="form-group">
              <ul class="page-breadcrumb">
                ...
                <li><a href="">Manage Special Offer Room Rates</a></li>
                <li><a class="active" href="<?php echo site_url(); ?>specialoffer/edit_rates_room">Edit Special Offer Room Rates</a></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-12">
        <section class="boxs">
          <div class="boxs-header dvd dvd-btm">
            <h1 class="custom-font">Edit Special Offer Room Rates</h1>
            <ul class="controls">              
          ...
          <div class="boxs-body">  
        <form action="<?php echo site_url();?>specialoffer/get_hotel_room_rates_def" method="post">            
              ...
              <div class="form-group col-md-6">
                ...
                <select class="form-control select2" name="contract" id="contract">
              ...
              <div class="form-group col-md-6" id="contractduration" style="display: none;">
                ...
                <div class="form-group col-md-6">
                 ...
                 <select class="form-control select2" name="market" id="market">
              ...
              <div class="form-group col-md-6">
                 <label class="strong" for="meal_plan">Select Meal Plan: </label>
                  <select class="form-control select2" name="meal_plan[]" id="meal_plan" multiple="multiple">                 
              ...
              <div class="row border_row"> 
               ...
               <div class="form-group col-md-6">
                  ...
                  <select name="specialoffer_type"  id="specialoffer_type" class="form-control select2">
...
<script type="text/javascript">
  ...
  $id = $(this).val();
  $.ajax({
    url: site_url+'specialoffer/get_hotel_details/',
    data: {id:$id},
    dataType: 'json',
    type: 'POST',
...
<script type="text/javascript">
  ...
  $id = $(this).val();
  $.ajax({
    url: site_url+'specialoffer/get_market_details/',
    data: {id:$id},
    dataType: 'json',
    type: 'POST',
    success: function(data) {   
