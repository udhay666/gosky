          ...
          <div class="page-bar br-5">
            <div class="form-group">
              <ul class="page-breadcrumb">
                ...
                <li><a href="">Manage Special Offer</a></li>
                <li><a class="active" href="<?php echo site_url(); ?>specialoffer/view_room_rates">View Special Offer Room Rates</a></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-12">
        <section class="boxs">
          <div class="boxs-header dvd dvd-btm">
            <h1 class="custom-font">View Special Offer Room Rates</h1>
            <ul class="controls">              
          ...
          <div class="boxs-body">  
        <form action="<?php echo site_url();?>specialoffer/view_cal_room_rates" method="post">  
