                 ...
                 <?php if($message==TRUE) 
                      {
                        ...
                        echo '<strong>Well done!</strong> new Special Offer Room Ratess added with success.';
                        echo '</div>';       
                     }
                  ?>
               </div>
            ...
            <div id="loadroomratedetails"> 
             ...
             <div class="form-group col-md-4">
              ...
              <!-- <input type="hidden" name="meal_plan" value="<?php echo $duplicateroomrates->meal_plan; ?>"> -->  
               <input type="hidden" name="specialoffer_id" value="<?php echo $duplicateroomrates->specialoffer_id; ?>">
              <input type="hidden" name="specialoffer_type" value="<?php echo $duplicateroomrates->specialoffer_type; ?>">           
               </div>              
               <div class="form-group col-md-5">
              <label class="strong" for="contract_no">Contract Period: <?php echo ' From '.date('d-M-Y',strtotime($contract_list[0]->start_date)).' to '.date('d-M-Y',strtotime($contract_list[0]->end_date)); ?></label>
             </div>
 ...
 <?php } else if($duplicateroomrates->rate_type=='PPPN'){  ?>
           ...
           <!--   <div class="row border_row">
               <div class="form-group col-md-4"> 
                ...
                <div class="form-group col-md-4 check_icon">                 
                    <label class="checkbox-inline checkbox-custom2 checkbox-custom2-sm">
                    <input type="radio" class="flat supplement_compulsory"   name="supplement_compulsory" value="Yes"  <?php if($duplicateroomrates->supplement_compulsory=='Yes'){echo 'checked="checked"';}?>>
                    <i></i> Yes
                    </label>               
                </div> 
                 <div class="form-group col-md-4 check_icon">                 
                   <label class="checkbox-inline checkbox-custom2 checkbox-custom2-sm">
                    <input type="radio" class="flat supplement_compulsory"   name="supplement_compulsory" value="No" <?php if(empty($duplicateroomrates->supplement_compulsory)){echo 'checked="checked"';} else if($duplicateroomrates->supplement_compulsory=='No'){echo 'checked="checked"';}?>>
                    <i></i> No 
                    </label> 
                  </div>                 
                </div>  -->

               <?php if($duplicateroomrates->specialoffer_id==1 && $duplicateroomrates->specialoffer_type=="Discount"){ ?> 
             <div class="row border_row">
               <div class="form-group col-md-6"> 
                <label class="strong">Special Offer Type : Discount</label> 
                 ...
                 <div class="form-group col-md-3"> 
                      <label class="strong">Enter Booking Code</label>
                       <input type="text" name="booking_code"  class="form-control"  placeholder="Enter Booking Code" value="<?php echo $duplicateroomrates->booking_code; ?>" required="required"/>
                   </div>
               </div>
               <div class="row border_row">
               <div class="form-group col-md-6 check_icon">                 
                <label class="checkbox-inline checkbox-custom2 checkbox-custom2-sm">
              <input type="radio" class="flat discount_rate_type"   name="discount_rate_type" value="net"  <?php if(empty($duplicateroomrates->discount_rate_type)){echo 'checked="checked"';} else if($duplicateroomrates->discount_rate_type=='net'){echo 'checked="checked"';}?>>
              <i></i> NET Discount 
              </label>               
              </div> 
              <div class="form-group col-md-6 check_icon">                 
            <label class="checkbox-inline checkbox-custom2 checkbox-custom2-sm">
              <input type="radio" class="flat discount_rate_type"   name="discount_rate_type" value="gross" <?php if($duplicateroomrates->discount_rate_type=='gross'){echo 'checked="checked"';}?>>
              <i></i> GROSS Discount 
              </label>
               </div>                 
                </div>
                ...
                <input type="text" name="min_no_of_stay_day"  id="min_no_of_stay_day" class="form-control Num"  placeholder="Min number of Nights" value="<?php echo $duplicateroomrates->min_no_of_stay_day;?>" required="required"/>
               </div>
             
                <div class="form-group col-md-4"> 
                <label class="strong">Max number of Nights</label> 
                
                <input type="text" name="max_no_of_stay_day"  id="max_no_of_stay_day" class="form-control Num"  placeholder="Max number of Nights" value="<?php echo $duplicateroomrates->max_no_of_stay_day;?>" required="required"/>
               </div>             
                <div class="form-group col-md-4"> 
              <label class="strong">Enter Discount Percentage(%)</label>              
              <input type="text" name="discount_percentage"  id="discount_percentage" class="form-control deciNum"  placeholder="Discount Percentage" value="<?php echo $duplicateroomrates->discount_percentage;?>" required="required"/>
               </div>
             </div>
              <!-- <div class="row  border_row policy_row">
                <div class="form-group col-md-3"> 
                ...
                <div class="form-group col-md-3">
                <input type="text" name="discount_percentage"  class="form-control deciNum"  value="<?php echo $duplicateroomrates->discount_percentage;?>" placeholder="Discount Percentage" required="required"/>
               </div>
             </div>  -->
            <?php }  else if($duplicateroomrates->specialoffer_id==2 && $duplicateroomrates->specialoffer_type=="Early bird"){ ?> 
                 <div class="row border_row">
                   <div class="form-group col-md-3"> 
                ...
                <div class="row border_row">
                  ...
                  <?php if($duplicateroomrates->prior_day_type=="prior_checkin"){ ?>
                       <input type="text" name="prior_checkin"  class="form-control Num"  placeholder="No of Prior Checkin Days" value="<?php echo $duplicateroomrates->prior_checkin;?>" required="required"/>
                  <?php } ?>
                  </div>
                  <div class="form-group col-md-6 check_icon">                 
                    <label class="checkbox-inline checkbox-custom2 checkbox-custom2-sm">
                      <input type="radio" class="flat prior_day_type"   name="prior_day_type" value="prior_checkin" <?php if($duplicateroomrates->prior_day_type=='prior_checkin'){echo 'checked="checked"';}?>>
                ...
                <div class="row border_row">
                 ...
                 <div class="form-group col-md-3" id="prior_checkin_date">
                  <?php if($duplicateroomrates->prior_day_type=="prior_checkin_date"){ ?>
                   <input type="text" name="prior_checkin_date" onClick="priorcheckin_date()"  value="<?php echo $duplicateroomrates->prior_checkin_date;?>" class="form-control"  placeholder="Select Prior Booking Date" required="required"/>
                    <?php } ?>
                 </div> 
                 <div class="form-group col-md-6 check_icon">                 
                      <label class="checkbox-inline checkbox-custom2 checkbox-custom2-sm">
                           <input type="radio" class="flat prior_day_type" name="prior_day_type" value="prior_checkin_date" <?php if($duplicateroomrates->prior_day_type=='prior_checkin_date'){echo 'checked="checked"';}?>>
              ...
              <div class="row border_row">
                <div class="form-group col-md-6" id="period">
                 <?php if($duplicateroomrates->prior_day_type=="period"){ ?>
                  <label class="strong">Period : </label>
                  <div class="row" style="margin-left:1px;">
                    <div class="form-group col-md-6">
                       <input type="text" class="form-control period_selectdate" onClick="period_selectdate()" id="period_from_date" name="period_from_date" value="<?php echo $duplicateroomrates->period_from_date;?>" placeholder="Select From Date" required="required">
                     </div>
                     <div class="form-group col-md-6">
                       <input type="text" class="form-control period_selectdate" onClick="period_selectdate()" id="period_to_date" name="period_to_date" value="<?php echo $duplicateroomrates->period_to_date;?>"  placeholder="Select To Date" required="required">
                     </div>
                 </div>
                   <?php } ?>
                </div>  
                <div class="form-group col-md-6 check_icon">                 
                   <label class="checkbox-inline checkbox-custom2 checkbox-custom2-sm">
                       <input type="radio" class="flat prior_day_type"   name="prior_day_type" value="period" <?php if($duplicateroomrates->prior_day_type=='period'){echo 'checked="checked"';}?>>
              ...
              <!--   <div class="row  border_row policy_row">
                ...
                <div class="form-group col-md-3">
                <input type="text" name="prior_checkin"  class="form-control Num"  value="<?php echo $duplicateroomrates->prior_checkin;?>" placeholder="No of Prior Checkin Days" required="required"/>
               </div>
             </div> -->
              <!--  </div> -->
            ...
            <label class="checkbox-inline checkbox-custom2 checkbox-custom2-sm">
              ...
              <div class="row  border_row">
                ...
                <div class="form-group col-md-3">
                <input type="text" name="discount_percentage"  id="discount_percentage"  class="form-control deciNum" value="<?php echo $duplicateroomrates->discount_percentage;?>" placeholder="Discount Percentage" required="required"/>
               </div>
             </div> 
            <?php } else if($duplicateroomrates->specialoffer_id==3 && $duplicateroomrates->specialoffer_type=="Stay Pay"){ ?> 
               <div class="row border_row">
                   <div class="form-group col-md-3"> 
             ...
             <!--    <div class="row  border_row policy_row">
               ...
               <div class="row  border_row">
                ...
                <input type="text" name="min_no_of_stay_day" id="min_no_of_stay_day"  class="form-control Num" value="<?php echo $duplicateroomrates->min_no_of_stay_day;?>" placeholder="Min number of stay days" required="required"/>
               </div>
             
                <div class="form-group col-md-4"> 
                <label class="strong">Max number of stay days</label> 
                
                <input type="text" name="max_no_of_stay_day" id="max_no_of_stay_day"  class="form-control Num"  value="<?php echo $duplicateroomrates->max_no_of_stay_day;?>" placeholder="Max number of stay days" required="required"/>
               </div>             
                <div class="form-group col-md-4"> 
                <label class="strong">No of free nights</label> 
               
                <input type="text" name="no_of_stay_free_nights"  id="no_of_stay_free_nights"  class="form-control Num" value="<?php echo $duplicateroomrates->no_of_stay_free_nights;?>" placeholder="No of free nights" required="required"/>
               </div>
             </div>

              
            <?php }  else if($duplicateroomrates->specialoffer_id==4 && $duplicateroomrates->specialoffer_type=="Supplement"){ ?> 
               <div class="row border_row">
               <div class="form-group col-md-6"> 
              ...
              <div class="row border_row">
               ...
               <div class="form-group col-md-5 check_icon">                 
                <label class="checkbox-inline checkbox-custom2 checkbox-custom2-sm">
              <input type="radio" class="flat supplement_compulsory"   name="supplement_compulsory" value="Yes" <?php if(empty($duplicateroomrates->supplement_compulsory)){echo 'checked="checked"';} else if($duplicateroomrates->supplement_compulsory=='Yes'){echo 'checked="checked"';}?>>
              <i></i> Yes
              </label>               
              </div> 
              <div class="form-group col-md-5 check_icon">                 
            <label class="checkbox-inline checkbox-custom2 checkbox-custom2-sm">
              <input type="radio" class="flat supplement_compulsory"   name="supplement_compulsory" value="No" <?php if($duplicateroomrates->supplement_compulsory=='No'){echo 'checked="checked"';}?>>
              <i></i> No 
              </label> 
              ...
              <option value="extra_charge" <?php if($duplicateroomrates->type_of_supplement=="extra_charge"){ echo 'selected';}?>> Extra Charges (on top of rate)</option>
              <option value="full_charge" <?php if($duplicateroomrates->type_of_supplement=="full_charge"){ echo 'selected';}?>>Full Charge</option>
                </select>
               </div>              
             </div>
               <div class="row  border_row">
                ...
                <input type="text" name="age_limit_for_supplement"  class="form-control Num"  value="<?php echo $duplicateroomrates->age_limit_for_supplement;?>" placeholder="Age limits for supplement" required="required"/>
               </div>
             
                <div class="form-group col-md-4"> 
                <label class="strong">Supplement Rate</label>
                
                <input type="text" name="supplement_rate"  class="form-control deciNum"  value="<?php echo $duplicateroomrates->supplement_rate;?>"  placeholder="Supplement Rate" required="required"/>
               </div>   
               </div>
               <div class="row  border_row policy_row">          
                <div class="form-group col-md-12"> 
                <label class="strong">Decription of Supplement</label> 
                <textarea name="supplement_desc" class="form-control" rows="5"  placeholder="Decription of Supplement" required="required"><?php echo $duplicateroomrates->supplement_desc;?></textarea>
               </div>
             </div>
...
<script type="text/javascript">
  ...
  $.ajax({
    url: site_url+'specialoffer/get_selected_mealplan_details/',
