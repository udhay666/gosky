...
<!--   <li  class="<?php if($steps == 3) echo 'active' ?>"><a href="<?php echo site_url() ?>contract/edit_step3?id=<?php echo $id ?>"><span class="step_no wizard-step">3</span><span class="step_descr">Step 3<br><small>Target</small></span></a></li> -->
  <li  class="<?php if($steps == 3) echo 'active' ?>"><a href="<?php echo site_url() ?>contract/edit_step3?id=<?php echo $id ?>"><span class="step_no wizard-step">3</span><span class="step_descr">Step 3<br><small>Types Of Rates</small></span></a></li>
  <li class="<?php if($steps == 4) echo 'active' ?>"><a href="<?php echo site_url() ?>contract/edit_step4?id=<?php echo $id ?>"><span class="step_no wizard-step">4</span><span class="step_descr">Step 4<br><small>Payment Condition</small></span></a></li> 
  <li class="<?php if($steps == 5) echo 'active' ?>"><a href="<?php echo site_url() ?>contract/edit_step5?id=<?php echo $id ?>"><span class="step_no wizard-step">5</span><span class="step_descr">Step 5<br><small>Comments</small></span></a></li>   
</ul>