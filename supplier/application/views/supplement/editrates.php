          ...
          <div class="page-bar br-5">
            <div class="form-group">
              <ul class="page-breadcrumb">
                ...
                <li><a class="active" href="<?php echo site_url(); ?>supplements/edit_rates_room">Edit Supplements Room Rates</a></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-12">
        <section class="boxs">
          <div class="boxs-header dvd dvd-btm">
            <h1 class="custom-font">Edit Supplements Room Rates</h1>
            <ul class="controls">              
          ...
          <div class="boxs-body">  
        <form action="<?php echo site_url();?>supplements/get_hotel_room_rates_def" method="post">            
              ...
              <div class="form-group col-md-6">
                 <label class="strong" for="meal_plan">Select Supplements Meal Plan: </label>
