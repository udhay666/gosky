            ...
            <?php } else if($duplicateroomrates->specialoffer_id==3 && $duplicateroomrates->specialoffer_type=="Stay Pay"){ ?> 
             ...
             <!--    <div class="row  border_row policy_row">
               ...
               <div class="row  border_row">
                ...
                <input type="text" name="min_no_of_stay_day"  class="form-control Num" value="<?php echo $duplicateroomrates->min_no_of_stay_day;?>" placeholder="Min number of stay days" required="required"/>
               </div>
             
                <div class="form-group col-md-4"> 
                <label class="strong">Max number of stay days</label> 
                
                <input type="text" name="max_no_of_stay_day"  class="form-control Num"  value="<?php echo $duplicateroomrates->max_no_of_stay_day;?>" placeholder="Max number of stay days" required="required"/>
               </div>             
                <div class="form-group col-md-4"> 
                <label class="strong">No of free nights</label> 
               
                <input type="text" name="no_of_stay_free_nights"  class="form-control Num" value="<?php echo $duplicateroomrates->no_of_stay_free_nights;?>" placeholder="No of free nights" required="required"/>
               </div>
             </div>
