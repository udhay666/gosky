...
public function do_upload(){
    ...
    $day_count = $this->input->post('day_count');
    if(!empty($day_count)){
        $imgpath = 'uploads/'.$this->supplier_id.'/'.$controller.'/'.$id.'/'.$table_name.'/'.$day_count.'/';
        $uploadpath = $this->upload_path.$controller.'/'.$id.'/'.$table_name.'/'.$day_count.'/';
    } else {
        if($table_name=='holiday_packages' || $table_name=='holiday_images'){
            $imgpath = 'uploads/'.$this->supplier_id.'/'.$controller.'/'.$id.'/'.$img_type.'/';
...
public function custom_upload($insert_id,$post,$to_do){
    ...
    $imgpath = 'uploads/'.$this->supplier_id.'/'.$controller.'/'.$id.'/'.$tablepath.'/'.$img_type.'/';
