...
class Sup_hotel_room_rates extends MY_Model {
    ...
    function delete_room_rates_old($hotel_id, $room_id, $startdate,$enddate,$contract_id,$market,$meal_plan) {
...
public function new_cal_get_roomrates_by_date($supplier_id,$hotel_id, $hotel_code, $room_id,$room_code,$contract_id='',$market='',$meal_plan='',$from_date='',$to_date='') {
        $this->db->select('*');
...
public function get_roomrates($sup_hotel_room_rates_id, $room_code, $hotel_code,$supplier_id,$sup_room_details_id,$contract_id){
     $this->db->select('*');
        $this->db->from('sup_hotel_room_rates');
 ...
 public function get_roomrates_edit($sup_hotel_id,$sup_hotel_room_rates_list_id,$sup_hotel_room_rates_id, $room_code, $hotel_code,$supplier_id,$sup_room_details_id,$contract_id,$market,$meal_plan){
     $this->db->select('*');
    $this->db->from('sup_hotel_room_rates');
    $this->db->where('sup_hotel_room_rates_id',$sup_hotel_room_rates_id);
...
public function get_roomrates_update($hotel_id,$sup_hotel_room_rates_list_id,$sup_hotel_room_rates_id, $room_code, $hotel_code,$supplier_id,$sup_room_details_id,$contract_id,$market,$meal_plan,$data){
    $this->db->where('sup_hotel_room_rates_id',$sup_hotel_room_rates_id);
    $this->db->where('sup_hotel_room_rates_list_id',$sup_hotel_room_rates_list_id);
    $this->db->where('room_code',$room_code);
    $this->db->where('sup_hotel_id',$hotel_id);
 ...
 {   
    ...
    {      
      ...
      public function get_roomrates_by_date($room_id, $startdate, $enddate,$contract_id) {
        $this->db->select('*');
        $this->db->from('sup_hotel_room_rates');
        $this->db->where('sup_room_details_id', $room_id);
        $this->db->where('contract_id', $contract_id);        
      ...
      public function get_roomallotment_by_date($room_id,$hotel_code,$startdate, $enddate,$contract_id,$room_allotment_type='') {
        $this->db->select('*');
        $this->db->from('sup_hotel_room_rates');
        $this->db->where('sup_room_details_id', $room_id);
        $this->db->where('hotel_code', $hotel_code);
