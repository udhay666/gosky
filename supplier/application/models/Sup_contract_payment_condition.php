...
class Sup_contract_payment_condition extends MY_Model {

    protected $_table_name = 'sup_contract_payment_condition';
...
function deletepaymentcondition($contract_id,$supplier_id)
{
