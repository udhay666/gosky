...
class Sup_hotel_room_details extends MY_Model {

    protected $_table_name = 'sup_hotel_room_details';
    protected $_primary_key = 'sup_room_details_id';
    protected $_primary_filter = 'intval';
    protected $_order_by = "sup_room_details_id Desc";
