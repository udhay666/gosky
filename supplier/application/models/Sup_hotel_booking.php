...
class Sup_hotel_booking extends MY_Model {

    protected $_table_name = 'sup_hotel_booking';
    protected $_primary_key = 'hotel_booking_id';
    protected $_primary_filter = 'intval';
    protected $_order_by = "hotel_booking_id desc";
