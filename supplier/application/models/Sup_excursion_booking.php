...
class Sup_excursion_booking extends MY_Model {

    protected $_table_name = 'holiday_booking_reports';
    protected $_primary_key = 'holiday_booking_id';
    protected $_primary_filter = 'intval';
    protected $_order_by = "holiday_booking_id desc";
