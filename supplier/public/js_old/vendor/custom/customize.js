...
function editrate(t){
  ...
  function update_editrate()
  {
   ...
   if(!deciNum.test($extra_bed_child)&&$extra_bed_child!=''){
    ...
    $.ajax({
      type: "POST",
      url: site_url + 'roomrates/update_room_rates_ind/',
      data : { room_fixed_rate : $room_fixed_rate , extra_bed_adult:$extra_bed_adult ,extra_bed_child:$extra_bed_child, hotel_code : $hotel_code , room_code:$room_code ,sup_room_details_id:$sup_room_details_id, sup_hotel_room_rates_id:$sup_hotel_room_rates_id },
      dataType : 'json',    
      success: function(data) {          
